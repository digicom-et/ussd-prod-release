export declare const API_ROUTE_METADATA: {
    ...
    readonly "POST /agents/:agentId/generate": {
        ...
        readonly pathParams: readonly ["agentId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["activeTools", "clientTools", "context", "instructions", "maxSteps", "memory", "messages", "modelSettings", "output", "providerOptions", "requestContext", "requireToolApproval", "returnScorerData", "runId", "savePerStep", "scorers", "stopWhen", "structuredOutput", "system", "toolChoice", "toolsets", "tracingOptions", "untilIdle", "versions"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "POST /agents/:agentId/send-message": {
        readonly method: "POST";
        readonly path: "/agents/:agentId/send-message";
        readonly pathParams: readonly ["agentId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "POST /agents/:agentId/queue-message": {
        readonly method: "POST";
        readonly path: "/agents/:agentId/queue-message";
        readonly pathParams: readonly ["agentId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "POST /agents/:agentId/threads/abort": {
        readonly method: "POST";
        readonly path: "/agents/:agentId/threads/abort";
        readonly pathParams: readonly ["agentId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["resourceId", "threadId"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "POST /agents/:agentId/send-tool-approval": {
        readonly method: "POST";
        readonly path: "/agents/:agentId/send-tool-approval";
        readonly pathParams: readonly ["agentId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["approved", "format", "messages", "requestContext", "resourceId", "resumeData", "streamOptions", "threadId", "toolCallId"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "GET /agents/:agentId/suspended-runs": {
        readonly method: "GET";
        readonly path: "/agents/:agentId/suspended-runs";
        readonly pathParams: readonly ["agentId"];
        readonly queryParams: readonly ["fromDate", "page", "perPage", "resourceId", "threadId", "toDate"];
        readonly bodyParams: readonly [];
        readonly hasQuery: true;
        readonly hasBody: false;
        readonly responseShape: {
    ...
    readonly "GET /auth/permission-patterns": {
        readonly method: "GET";
        readonly path: "/auth/permission-patterns";
        readonly pathParams: readonly [];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
        ...
        readonly responseShape: {
            readonly kind: "object-property";
            readonly listProperty: "patterns";
        };
    };
    ...
    readonly "POST /workflows/:workflowId/resume-no-wait": {
        readonly method: "POST";
        readonly path: "/workflows/:workflowId/resume-no-wait";
        readonly pathParams: readonly ["workflowId"];
        readonly queryParams: readonly ["runId"];
        readonly bodyParams: readonly ["forEachIndex", "perStep", "requestContext", "resumeData", "step", "tracingOptions"];
        readonly hasQuery: true;
    ...
    readonly "POST /agents/:agentId/generate-legacy": {
        ...
        readonly pathParams: readonly ["agentId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["activeTools", "clientTools", "context", "instructions", "maxSteps", "memory", "messages", "modelSettings", "output", "providerOptions", "requestContext", "requireToolApproval", "resourceId", "resourceid", "returnScorerData", "runId", "savePerStep", "scorers", "stopWhen", "structuredOutput", "system", "threadId", "toolChoice", "toolsets", "tracingOptions", "untilIdle", "versions"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "GET /stored/agents/:storedAgentId/dependents": {
        readonly method: "GET";
        readonly path: "/stored/agents/:storedAgentId/dependents";
        ...
        readonly responseShape: {
            readonly kind: "object-property";
            readonly listProperty: "dependents";
        };
    };
    readonly "POST /stored/agents/:storedAgentId/export": {
        readonly method: "POST";
        readonly path: "/stored/agents/:storedAgentId/export";
        readonly pathParams: readonly ["storedAgentId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["agents", "browser", "defaultOptions", "description", "inputProcessors", "instructions", "integrationTools", "mcpClients", "memory", "model", "name", "outputProcessors", "requestContextSchema", "scorers", "skills", "toolProviders", "tools", "workflows", "workspace"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "POST /stored/agents/:storedAgentId/change-request": {
        readonly method: "POST";
        readonly path: "/stored/agents/:storedAgentId/change-request";
        readonly pathParams: readonly ["storedAgentId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["agents", "browser", "changeMessage", "defaultOptions", "description", "inputProcessors", "inspectOnly", "instructions", "integrationTools", "mcpClients", "memory", "model", "name", "outputProcessors", "requestContextSchema", "scorers", "skills", "toolProviders", "tools", "userName", "workflows", "workspace"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "POST /stored/agents": {
        ...
        readonly pathParams: readonly [];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["agents", "authorId", "browser", "defaultOptions", "description", "id", "inputProcessors", "instructions", "integrationTools", "mcpClients", "memory", "metadata", "model", "name", "outputProcessors", "requestContextSchema", "scorers", "skills", "toolProviders", "tools", "visibility", "workflows", "workspace"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "PATCH /stored/agents/:storedAgentId": {
        ...
        readonly pathParams: readonly ["storedAgentId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["agents", "authorId", "browser", "changeMessage", "defaultOptions", "description", "inputProcessors", "instructions", "integrationTools", "mcpClients", "memory", "metadata", "model", "name", "outputProcessors", "requestContextSchema", "scorers", "skills", "toolProviders", "tools", "visibility", "workflows", "workspace"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "PATCH /stored/workspaces/:storedWorkspaceId": {
        ...
        readonly pathParams: readonly ["storedWorkspaceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["autoSync", "description", "filesystem", "metadata", "mounts", "name", "operationTimeout", "sandbox", "search", "skills", "tools"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "POST /tool-providers/:providerId/authorize": {
        readonly method: "POST";
        readonly path: "/tool-providers/:providerId/authorize";
        readonly pathParams: readonly ["providerId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["config", "connectionId", "label", "scope", "toolName", "toolkit"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "GET /tool-providers/:providerId/auth-status/:authId": {
        readonly method: "GET";
        readonly path: "/tool-providers/:providerId/auth-status/:authId";
        readonly pathParams: readonly ["providerId", "authId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
        readonly hasBody: false;
    ...
    readonly "POST /tool-providers/:providerId/connection-status": {
        readonly method: "POST";
        readonly path: "/tool-providers/:providerId/connection-status";
        readonly pathParams: readonly ["providerId"];
        readonly queryParams: readonly [];
    ...
    readonly "GET /tool-providers/:providerId/connections": {
        readonly method: "GET";
        readonly path: "/tool-providers/:providerId/connections";
        readonly pathParams: readonly ["providerId"];
        readonly queryParams: readonly ["authorId", "page", "perPage", "scope", "toolkit"];
        readonly bodyParams: readonly [];
        readonly hasQuery: true;
        readonly hasBody: false;
        readonly responseShape: {
    ...
    readonly "GET /tool-providers/:providerId/connection-fields": {
        readonly method: "GET";
        readonly path: "/tool-providers/:providerId/connection-fields";
        readonly pathParams: readonly ["providerId"];
        readonly queryParams: readonly ["toolkit"];
        readonly bodyParams: readonly [];
        readonly hasQuery: true;
        readonly hasBody: false;
        readonly responseShape: {
            readonly kind: "object-property";
            readonly listProperty: "fields";
        };
    };
    readonly "DELETE /tool-providers/:providerId/connections/:connectionId": {
        readonly method: "DELETE";
        readonly path: "/tool-providers/:providerId/connections/:connectionId";
        readonly pathParams: readonly ["providerId", "connectionId"];
        readonly queryParams: readonly ["force", "toolkit"];
        readonly bodyParams: readonly [];
        readonly hasQuery: true;
        readonly hasBody: false;
        readonly responseShape: {
    ...
    readonly "PATCH /tool-providers/:providerId/connections/:connectionId": {
        readonly method: "PATCH";
        readonly path: "/tool-providers/:providerId/connections/:connectionId";
        readonly pathParams: readonly ["providerId", "connectionId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["label"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "GET /tool-providers/:providerId/connections/:connectionId/usage": {
        readonly method: "GET";
        readonly path: "/tool-providers/:providerId/connections/:connectionId/usage";
        readonly pathParams: readonly ["providerId", "connectionId"];
        readonly queryParams: readonly ["toolkit"];
        readonly bodyParams: readonly [];
        readonly hasQuery: true;
    ...
    readonly "GET /tool-providers/:providerId/health": {
        readonly method: "GET";
        readonly path: "/tool-providers/:providerId/health";
        readonly pathParams: readonly ["providerId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "POST /datasets/:datasetId/items": {
        ...
        readonly pathParams: readonly ["datasetId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["expectedTrajectory", "groundTruth", "input", "metadata", "requestContext", "source", "toolMocks"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "GET /editor/builder/models/available": {
        readonly method: "GET";
        readonly path: "/editor/builder/models/available";
        readonly pathParams: readonly [];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "GET /agent-builder": {
        readonly method: "GET";
        readonly path: "/agent-builder";
        readonly pathParams: readonly [];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "GET /agent-builder/:actionId": {
        readonly method: "GET";
        readonly path: "/agent-builder/:actionId";
        readonly pathParams: readonly ["actionId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
        readonly hasBody: false;
    ...
    readonly "GET /agent-builder/:actionId/runs": {
        readonly method: "GET";
        readonly path: "/agent-builder/:actionId/runs";
        readonly pathParams: readonly ["actionId"];
        readonly queryParams: readonly ["fromDate", "limit", "offset", "page", "perPage", "resourceId", "status", "toDate"];
        readonly bodyParams: readonly [];
        readonly hasQuery: true;
    ...
    readonly "GET /agent-builder/:actionId/runs/:runId": {
        readonly method: "GET";
        readonly path: "/agent-builder/:actionId/runs/:runId";
        readonly pathParams: readonly ["actionId", "runId"];
        readonly queryParams: readonly ["fields", "withNestedWorkflows"];
        readonly bodyParams: readonly [];
        readonly hasQuery: true;
        readonly hasBody: false;
    ...
    readonly "POST /agent-builder/:actionId/create-run": {
        readonly method: "POST";
        readonly path: "/agent-builder/:actionId/create-run";
        readonly pathParams: readonly ["actionId"];
        readonly queryParams: readonly ["runId"];
        readonly bodyParams: readonly [];
        readonly hasQuery: true;
    ...
    readonly "POST /agent-builder/:actionId/start-async": {
        readonly method: "POST";
        readonly path: "/agent-builder/:actionId/start-async";
        readonly pathParams: readonly ["actionId"];
        readonly queryParams: readonly ["runId"];
        readonly bodyParams: readonly ["initialState", "inputData", "perStep", "requestContext", "resourceId", "tracingOptions"];
        readonly hasQuery: true;
    ...
    readonly "POST /agent-builder/:actionId/start": {
        readonly method: "POST";
        readonly path: "/agent-builder/:actionId/start";
        readonly pathParams: readonly ["actionId"];
        readonly queryParams: readonly ["runId"];
        readonly bodyParams: readonly ["initialState", "inputData", "perStep", "requestContext", "resourceId", "tracingOptions"];
        readonly hasQuery: true;
    ...
    readonly "POST /agent-builder/:actionId/resume-async": {
        readonly method: "POST";
        readonly path: "/agent-builder/:actionId/resume-async";
        readonly pathParams: readonly ["actionId"];
        readonly queryParams: readonly ["runId"];
        readonly bodyParams: readonly ["forEachIndex", "perStep", "requestContext", "resumeData", "step", "tracingOptions"];
        readonly hasQuery: true;
    ...
    readonly "POST /agent-builder/:actionId/resume-no-wait": {
        readonly method: "POST";
        readonly path: "/agent-builder/:actionId/resume-no-wait";
        readonly pathParams: readonly ["actionId"];
        readonly queryParams: readonly ["runId"];
        readonly bodyParams: readonly ["forEachIndex", "perStep", "requestContext", "resumeData", "step", "tracingOptions"];
        readonly hasQuery: true;
    ...
    readonly "POST /agent-builder/:actionId/resume": {
        readonly method: "POST";
        readonly path: "/agent-builder/:actionId/resume";
        readonly pathParams: readonly ["actionId"];
        readonly queryParams: readonly ["runId"];
        readonly bodyParams: readonly ["forEachIndex", "perStep", "requestContext", "resumeData", "step", "tracingOptions"];
        readonly hasQuery: true;
    ...
    readonly "POST /agent-builder/:actionId/runs/:runId/cancel": {
        readonly method: "POST";
        readonly path: "/agent-builder/:actionId/runs/:runId/cancel";
        readonly pathParams: readonly ["actionId", "runId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "GET /heartbeats": {
        readonly method: "GET";
        readonly path: "/heartbeats";
        readonly pathParams: readonly [];
        readonly queryParams: readonly ["agentId", "name", "resourceId", "threadId"];
        readonly bodyParams: readonly [];
        readonly hasQuery: true;
        readonly hasBody: false;
        readonly responseShape: {
            readonly kind: "object-property";
            readonly listProperty: "heartbeats";
        };
    };
    readonly "GET /heartbeats/:heartbeatId": {
        readonly method: "GET";
        readonly path: "/heartbeats/:heartbeatId";
        readonly pathParams: readonly ["heartbeatId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
        readonly hasBody: false;
    ...
    readonly "POST /heartbeats": {
        readonly method: "POST";
        readonly path: "/heartbeats";
        readonly pathParams: readonly [];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["agentId", "attributes", "cron", "id", "ifActive", "ifIdle", "metadata", "name", "prompt", "providerOptions", "resourceId", "signalType", "tagName", "threadId", "timezone"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "PATCH /heartbeats/:heartbeatId": {
        readonly method: "PATCH";
        readonly path: "/heartbeats/:heartbeatId";
        readonly pathParams: readonly ["heartbeatId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["attributes", "cron", "ifActive", "ifIdle", "metadata", "name", "prompt", "providerOptions", "signalType", "tagName", "timezone"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "DELETE /heartbeats/:heartbeatId": {
        readonly method: "DELETE";
        readonly path: "/heartbeats/:heartbeatId";
        readonly pathParams: readonly ["heartbeatId"];
        readonly queryParams: readonly [];
    ...
    readonly "POST /heartbeats/:heartbeatId/pause": {
        readonly method: "POST";
        readonly path: "/heartbeats/:heartbeatId/pause";
        readonly pathParams: readonly ["heartbeatId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "POST /heartbeats/:heartbeatId/resume": {
        readonly method: "POST";
        readonly path: "/heartbeats/:heartbeatId/resume";
        readonly pathParams: readonly ["heartbeatId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "POST /heartbeats/:heartbeatId/run": {
        readonly method: "POST";
        readonly path: "/heartbeats/:heartbeatId/run";
        readonly pathParams: readonly ["heartbeatId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "GET /agent-controller": {
        readonly method: "GET";
        readonly path: "/agent-controller";
        readonly pathParams: readonly [];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
        ...
        readonly responseShape: {
            readonly kind: "object-property";
            readonly listProperty: "agentControllers";
        };
    };
    readonly "GET /agent-controller/:controllerId/modes": {
        readonly method: "GET";
        readonly path: "/agent-controller/:controllerId/modes";
        readonly pathParams: readonly ["controllerId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
        readonly hasBody: false;
        readonly responseShape: {
            readonly kind: "object-property";
            readonly listProperty: "modes";
        };
    };
    readonly "GET /agent-controller/:controllerId/models": {
        readonly method: "GET";
        readonly path: "/agent-controller/:controllerId/models";
        readonly pathParams: readonly ["controllerId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
        ...
        readonly responseShape: {
            readonly kind: "object-property";
            readonly listProperty: "models";
        };
    };
    readonly "POST /agent-controller/:controllerId/sessions": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions";
        readonly pathParams: readonly ["controllerId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["resourceId", "tags"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "GET /agent-controller/:controllerId/sessions/:resourceId": {
        readonly method: "GET";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
        readonly hasBody: false;
    ...
    readonly "GET /agent-controller/:controllerId/sessions/:resourceId/threads": {
        readonly method: "GET";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/threads";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly ["limit", "tags"];
        readonly bodyParams: readonly [];
        readonly hasQuery: true;
        readonly hasBody: false;
        readonly responseShape: {
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/threads": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/threads";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["title"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "DELETE /agent-controller/:controllerId/sessions/:resourceId/threads/:threadId": {
        readonly method: "DELETE";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/threads/:threadId";
        readonly pathParams: readonly ["controllerId", "resourceId", "threadId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
        readonly hasBody: false;
    ...
    readonly "PUT /agent-controller/:controllerId/sessions/:resourceId/threads/:threadId": {
        readonly method: "PUT";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/threads/:threadId";
        readonly pathParams: readonly ["controllerId", "resourceId", "threadId"];
        readonly queryParams: readonly [];
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/threads/clone": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/threads/clone";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["sourceThreadId", "title"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "GET /agent-controller/:controllerId/sessions/:resourceId/threads/:threadId/messages": {
        readonly method: "GET";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/threads/:threadId/messages";
        readonly pathParams: readonly ["controllerId", "resourceId", "threadId"];
        readonly queryParams: readonly ["limit"];
        readonly bodyParams: readonly [];
        readonly hasQuery: true;
        readonly hasBody: false;
        readonly responseShape: {
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/messages": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/messages";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["message"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/steer": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/steer";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["message"];
        readonly hasQuery: false;
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/follow-up": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/follow-up";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["message"];
        readonly hasQuery: false;
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/abort": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/abort";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/tool-approval": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/tool-approval";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["approved", "toolCallId"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/tool-suspension": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/tool-suspension";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["resumeData", "toolCallId"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/mode": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/mode";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["modeId"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/model": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/model";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["modeId", "modelId", "scope"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/thread": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/thread";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["threadId"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/notifications": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/notifications";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["attributes", "coalesceKey", "dedupeKey", "kind", "metadata", "payload", "priority", "source", "sourceId", "summary"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "GET /agent-controller/:controllerId/workspace": {
        readonly method: "GET";
        readonly path: "/agent-controller/:controllerId/workspace";
        readonly pathParams: readonly ["controllerId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "GET /agent-controller/:controllerId/sessions/:resourceId/om": {
        readonly method: "GET";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/om";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/resource": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/resource";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["newResourceId"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "GET /agent-controller/:controllerId/sessions/:resourceId/resources": {
        readonly method: "GET";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/resources";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
        ...
        readonly responseShape: {
            readonly kind: "object-property";
            readonly listProperty: "resourceIds";
        };
    };
    readonly "GET /agent-controller/:controllerId/sessions/:resourceId/goal": {
        readonly method: "GET";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/goal";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "POST /agent-controller/:controllerId/sessions/:resourceId/goal": {
        readonly method: "POST";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/goal";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["judgeModelId", "maxRuns", "objective"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "PUT /agent-controller/:controllerId/sessions/:resourceId/goal": {
        readonly method: "PUT";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/goal";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["judgeModelId", "maxRuns", "status"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "DELETE /agent-controller/:controllerId/sessions/:resourceId/goal": {
        readonly method: "DELETE";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/goal";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
    ...
    readonly "GET /agent-controller/:controllerId/sessions/:resourceId/permissions": {
        readonly method: "GET";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/permissions";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly [];
        readonly hasQuery: false;
    ...
    readonly "PUT /agent-controller/:controllerId/sessions/:resourceId/permissions/category": {
        readonly method: "PUT";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/permissions/category";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["category", "policy"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "PUT /agent-controller/:controllerId/sessions/:resourceId/permissions/tool": {
        readonly method: "PUT";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/permissions/tool";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["policy", "toolName"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
    ...
    readonly "PUT /agent-controller/:controllerId/sessions/:resourceId/state": {
        readonly method: "PUT";
        readonly path: "/agent-controller/:controllerId/sessions/:resourceId/state";
        readonly pathParams: readonly ["controllerId", "resourceId"];
        readonly queryParams: readonly [];
        readonly bodyParams: readonly ["state"];
        readonly hasQuery: false;
        readonly hasBody: true;
        readonly responseShape: {
            readonly kind: "single";
