import { toStandardSchema, standardSchemaToJSONSchema, isStandardSchemaWithJSON } from './chunk-JRKBFHQT.js';
...
var SchemaCompatLayer = class {
  ...
  defaultZodIntersectionHandler(value) {
    ...
    if (processed.every((p) => p instanceof ZodObject)) {
      ...
      let result = z$1.object(mergedShape);
      if (value.description) {
        result = result.describe(value.description);
      }
      return result;
    }
    return z$1.any().describe(value.description || "intersection type");
  }
  /**
