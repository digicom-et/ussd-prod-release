...
function convertZodSchemaToAISDKSchema(zodSchema2, target = "jsonSchema7") {
  const jsonSchemaToUse = chunkLQOEEQF6_cjs.zodToJsonSchema(zodSchema2, target);
...
var import_json_schema_traverse = chunkDZUJEN5N_cjs.__toESM(chunkSKPYVQBT_cjs.require_json_schema_traverse(), 1);
