...
function protocolExternalResolver({ exclude = ["node:"] } = {}) {
  return {
    ...
    resolveId(id) {
      if (!chunk7PMC7SBC_cjs.isExternalProtocolImport(id, exclude)) {
        return null;
      }
      return {
        id,
...
function subpathExternalsResolver(externals) {
  return {
    ...
    resolveId(id) {
      ...
      const isPartOfExternals = externals.some((external) => chunk7PMC7SBC_cjs.isDependencyPartOfPackage(id, external));
...
//# sourceMappingURL=chunk-I7TERDMR.cjs.map
//# sourceMappingURL=chunk-I7TERDMR.cjs.map