...
export declare const TABLE_TOOL_PROVIDER_CONNECTIONS = "mastra_tool_provider_connections";
export declare const TABLE_NOTIFICATIONS = "mastra_notifications";
export declare const TABLE_HARNESS_SESSIONS = "mastra_harness_sessions";
export declare const TABLE_THREAD_STATE = "mastra_thread_state";
/** Union of all core table name constants. */
export type TABLE_NAMES = typeof TABLE_WORKFLOW_SNAPSHOT | typeof TABLE_MESSAGES | typeof TABLE_THREADS | typeof TABLE_TRACES | typeof TABLE_RESOURCES | typeof TABLE_SCORERS | typeof TABLE_SPANS | typeof TABLE_AGENTS | typeof TABLE_AGENT_VERSIONS | typeof TABLE_PROMPT_BLOCKS | typeof TABLE_PROMPT_BLOCK_VERSIONS | typeof TABLE_SCORER_DEFINITIONS | typeof TABLE_SCORER_DEFINITION_VERSIONS | typeof TABLE_MCP_CLIENTS | typeof TABLE_MCP_CLIENT_VERSIONS | typeof TABLE_MCP_SERVERS | typeof TABLE_MCP_SERVER_VERSIONS | typeof TABLE_WORKSPACES | typeof TABLE_WORKSPACE_VERSIONS | typeof TABLE_SKILLS | typeof TABLE_SKILL_VERSIONS | typeof TABLE_SKILL_BLOBS | typeof TABLE_DATASETS | typeof TABLE_DATASET_ITEMS | typeof TABLE_DATASET_VERSIONS | typeof TABLE_EXPERIMENTS | typeof TABLE_EXPERIMENT_RESULTS | typeof TABLE_BACKGROUND_TASKS | typeof TABLE_FAVORITES | typeof TABLE_SCHEDULES | typeof TABLE_SCHEDULE_TRIGGERS | typeof TABLE_CHANNEL_INSTALLATIONS | typeof TABLE_CHANNEL_CONFIG | typeof TABLE_TOOL_PROVIDER_CONNECTIONS | typeof TABLE_NOTIFICATIONS | typeof TABLE_HARNESS_SESSIONS | typeof TABLE_THREAD_STATE;
export declare const SCORERS_SCHEMA: Record<string, StorageColumn>;
export declare const SPAN_SCHEMA: Record<"error" | "attributes" | "requestContext" | "name" | "entityType" | "entityId" | "entityName" | "input" | "metadata" | "traceId" | "output" | "spanId" | "createdAt" | "updatedAt" | "spanType" | "isEvent" | "startedAt" | "parentSpanId" | "experimentId" | "links" | "endedAt" | "tags" | "source" | "parentEntityType" | "parentEntityId" | "parentEntityName" | "rootEntityType" | "rootEntityId" | "rootEntityName" | "userId" | "organizationId" | "resourceId" | "runId" | "sessionId" | "threadId" | "requestId" | "environment" | "serviceName" | "scope" | "entityVersionId" | "parentEntityVersionId" | "rootEntityVersionId", StorageColumn>;
/**
 ...
 * context).
 */
export declare const TOOL_PROVIDER_CONNECTIONS_SCHEMA: Record<string, StorageColumn>;
export declare const NOTIFICATIONS_SCHEMA: Record<string, StorageColumn>;
export declare const HARNESS_SESSIONS_SCHEMA: Record<string, StorageColumn>;
export declare const THREAD_STATE_SCHEMA: Record<string, StorageColumn>;
