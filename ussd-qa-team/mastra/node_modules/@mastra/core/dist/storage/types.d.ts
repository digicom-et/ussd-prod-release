 ...
 */
export type StorageDefaultOptions = Omit<AgentExecutionOptionsBase<any>, 'onStepFinish' | 'onFinish' | 'onChunk' | 'onError' | 'onAbort' | 'prepareStep' | 'abortSignal' | 'requestContext' | 'tracingContext' | 'inputProcessors' | 'outputProcessors' | 'clientTools' | 'scorers' | 'toolsets' | 'context' | 'memory' | 'instructions' | 'system' | 'stopWhen' | 'providerOptions' | 'requireToolApproval'> & {
    /**
...
export declare const STORAGE_VISIBILITY_VALUES: readonly ["private", "public"];
...
export declare const STORAGE_FAVORITE_ENTITY_TYPES: readonly ["agent", "skill"];
/**
