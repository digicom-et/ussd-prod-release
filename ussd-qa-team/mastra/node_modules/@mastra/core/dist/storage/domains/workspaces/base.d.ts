import type { StorageWorkspaceType, StorageWorkspaceSnapshotType, StorageResolvedWorkspaceType, StorageCreateWorkspaceInput, StorageUpdateWorkspaceInput, StorageListWorkspacesInput, StorageListWorkspacesOutput, StorageListWorkspacesResolvedOutput } from '../../types.js';
...
export declare abstract class WorkspacesStorage extends VersionedStorageDomain<StorageWorkspaceType, StorageWorkspaceSnapshotType, StorageResolvedWorkspaceType, WorkspaceVersion, CreateWorkspaceVersionInput, ListWorkspaceVersionsInput, ListWorkspaceVersionsOutput, {
    workspace: StorageCreateWorkspaceInput;
}, StorageUpdateWorkspaceInput, StorageListWorkspacesInput | undefined, StorageListWorkspacesOutput, StorageListWorkspacesResolvedOutput> {
    protected readonly listKey = "workspaces";
    protected readonly versionMetadataFields: ("createdAt" | "id" | "workspaceId" | "versionNumber" | "changedFields" | "changeMessage")[];
    constructor();
}
