...
// ../_internals/auth/dist/chunk-N7AFRB23.js
...
var CompositeAuth = class extends MastraAuthProvider {
  ...
  constructor(providers) {
    ...
    const credProvider = this.findProvider(isCredentialsProvider);
    if (credProvider) {
      this.signIn = credProvider.signIn.bind(credProvider);
      if (typeof credProvider.signUp === "function") {
        this.signUp = credProvider.signUp.bind(credProvider);
      }
      if (typeof credProvider.requestPasswordReset === "function") {
        this.requestPasswordReset = credProvider.requestPasswordReset.bind(credProvider);
      }
      if (typeof credProvider.resetPassword === "function") {
        this.resetPassword = credProvider.resetPassword.bind(credProvider);
      }
...
export { CompositeAuth, MastraAuthProvider, SimpleAuth, getRequestHeader, getWebRequest };
//# sourceMappingURL=chunk-VAQRZL6A.js.map
//# sourceMappingURL=chunk-VAQRZL6A.js.map