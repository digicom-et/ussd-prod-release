...
var MastraVoice = class extends chunkWSD4JNMB_cjs.MastraBase {
  listeningModel;
  speechModel;
  speaker;
  realtimeConfig;
...
var AISDKSpeech = class extends MastraVoice {
  ...
  async speak(input, options) {
    ...
    const result = await chunkVRIGWPHF_cjs.generateSpeech({
      model: this.model,
      text,
...
var AISDKTranscription = class extends MastraVoice {
  ...
  async listen(audioStream, options) {
    ...
    const result = await chunkVRIGWPHF_cjs.transcribe({
      model: this.model,
      audio: audioBuffer,
      providerOptions: options?.providerOptions,
      abortSignal: options?.abortSignal,
...
// ../_internals/voice/dist/chunk-QKHIWUAE.js
var supportedSpecificationVersions = ["v2", "v3"];
...
var CompositeVoice = class extends MastraVoice {
  ...
  async speak(input, options) {
    ...
    throw new chunkXSOONORA_cjs.MastraError({
      ...
      domain: chunkXSOONORA_cjs.ErrorDomain.MASTRA_VOICE,
...
//# sourceMappingURL=chunk-SNZGD64V.cjs.map
//# sourceMappingURL=chunk-SNZGD64V.cjs.map