...
var BrowserContextProcessor = class {
  ...
  async computeStateSignal(args) {
    ...
    if (previousState?.open && browserState.open && previousState.activeUrl && browserState.activeUrl && previousState.activeUrl !== browserState.activeUrl && previousState.processId === browserState.processId && browserState.activeUrlChangeSource !== "agent") {
      const recentClickUrl = getMostRecentBrowserClickResultUrl(args.steps) ?? getMostRecentBrowserClickResultUrlFromMessageList(args.messageList);
...
2. Remove profile/executablePath to connect to the existing browser via CDP`
  ...
  getInputProcessors(configuredProcessors = []) {
    const hasProcessor = configuredProcessors.some(
      (p) => !chunkH3Y3YAMF_cjs.isProcessorWorkflow(p) && "id" in p && p.id === "browser-context"
    );
...
function createBrowserRecordingTools(browser, options) {
  ...
  return {
    browser_record: chunkDZ44ZU2T_cjs.createTool({
      id: "browser_record",
    ...
    browser_record_caption: chunkDZ44ZU2T_cjs.createTool({
...
Object.defineProperty(exports, "BrowserCliHandler", {
  enumerable: true,
  get: function () { return chunkQJ3FDYCK_cjs.BrowserCliHandler; }
});
Object.defineProperty(exports, "browserCliHandler", {
  enumerable: true,
  get: function () { return chunkQJ3FDYCK_cjs.browserCliHandler; }
