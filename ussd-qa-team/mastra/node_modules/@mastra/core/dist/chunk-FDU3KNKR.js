import { isToolUIPart, convertToModelMessages } from './chunk-JPZJEO6I.js';
import { isToolUIPart as isToolUIPart$1 } from './chunk-TOBPSKTN.js';
import { convertToCoreMessages } from './chunk-D23QKBCZ.js';
import { DefaultGeneratedFileWithType } from './chunk-HHYICF3X.js';
import { fetchWithRetry } from './chunk-RBJJ4Y4N.js';
import { MastraError, ErrorCategory, ErrorDomain } from './chunk-M7RBQNFP.js';
import { v4 } from '@lukeed/uuid';
import { convertUint8ArrayToBase64, isUrlSupported, convertBase64ToUint8Array } from '@ai-sdk/provider-utils-v5';
...
var AIV6Adapter = class _AIV6Adapter {
  ...
  static fromUIMessage(uiMsg) {
    const compatibleParts = uiMsg.parts.filter((part) => {
      ...
      if (isToolUIPart$1(part)) return false;
      return true;
    });
...
function aiV5UIMessagesToAIV5ModelMessages(messages, dbMessages, filterIncompleteToolCalls = false) {
  ...
  for (const uiMsg of preprocessed) {
    const produced = convertToModelMessages([uiMsg]);
...
export { AIV4Adapter, AIV5Adapter, AIV6Adapter, CacheKeyGenerator, MessageList, MessageMerger, MessageStateManager, TypeDetector, aiV4CoreMessageToV1PromptMessage, aiV5ModelMessageToV2PromptMessage, convertMessages, coreContentToString, createMessageSignal, createSignal, dataPartToSignal, ensureAnthropicCompatibleMessages, ensureGeminiCompatibleMessages, findToolCallArgs, getOpenAIReasoningItemId, getResponseProviderItemId, getResponseProviderItemIdFromPart, getResponseProviderItemIds, getResponseProviderItemKey, getResponseProviderItemKeys, getTransformedToolPayload, hasOpenAIReasoningItemId, hasResponseProviderItemId, hasTransformedToolPayload, isCreatedAgentSignal, isMastraSignalMessage, mastraDBMessageToSignal, messagesAreEqual, normalizeToolPayloadTransformPolicy, resolveDeliveryAttributes, sanitizeOrphanedToolPairs, sanitizeToolName, signalToDataPartFormat, signalToMastraDBMessage, signalToMessage, signalToXmlMarkup, stableStringify, transformToolPayloadForTargets, withToolPayloadTransformMetadata, withToolPayloadTransformProviderMetadata };
//# sourceMappingURL=chunk-FDU3KNKR.js.map
//# sourceMappingURL=chunk-FDU3KNKR.js.map