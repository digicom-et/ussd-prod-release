...
import type { InlineLinkEntry } from './inline-media.js';
import type { TypingStatusFn } from './typing-status.js';
import type { WaitUntilFn, WaitUntilResolver } from './wait-until.js';
export type { InlineLinkEntry } from './inline-media.js';
 ...
 */
export type StreamingConfig = boolean | {
 ...
 */
export type ChannelAdapterConfig = ChannelAdapterStaticConfig | ChannelAdapterStreamingConfig | ChannelAdapterLegacyConfig;
/**
