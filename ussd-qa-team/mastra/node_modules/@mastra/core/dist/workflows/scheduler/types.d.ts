 ...
 */
export type WorkflowScheduleInput<TInput = unknown, TState = unknown, TRequestContext = unknown> = WorkflowScheduleConfig<TInput, TState, TRequestContext> | WorkflowScheduleConfig<TInput, TState, TRequestContext>[];
/**
