import type { AssistantContent, CoreMessage, ToolContent, UserContent } from '../_types/@internal_ai-sdk-v4/dist/index.d.ts';
...
import type { VectorFilter } from '../vector/filter/base.js';
 ...
 */
export declare function getThreadOMMetadata(threadMetadata?: Record<string, unknown>): ThreadOMMetadata | undefined;
/**
 ...
 */
export declare function setThreadOMMetadata(threadMetadata: Record<string, unknown> | undefined, omMetadata: ThreadOMMetadata): Record<string, unknown>;
/**
 ...
 * - `undefined` → disabled
 */
export declare function isObservationalMemoryEnabled(config: boolean | ObservationalMemoryOptions | undefined): config is true | ObservationalMemoryOptions;
/**
