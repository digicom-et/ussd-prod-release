import type { MastraAuthConfig as InternalMastraAuthConfig } from '../_types/@internal_auth/dist/types/index.d.ts';
import type { Handler, MiddlewareHandler, Context } from '../_types/hono/dist/types/index.d.ts';
import type { cors } from '../_types/hono/dist/types/middleware/cors/index.d.ts';
import type { DescribeRouteOptions } from '../_types/hono-openapi/dist/index.d.ts';
import type { ZodError } from 'zod/v4';
import type { FGARouteConfig, IFGAProvider } from '../auth/ee/interfaces/fga.js';
import type { MastraFGAPermissionInput } from '../auth/ee/interfaces/permissions.generated.js';
import type { IRBACProvider } from '../auth/ee/interfaces/rbac.js';
...
export type ValidationErrorHook = (error: ZodError, context: ValidationErrorContext) => ValidationErrorResponse | undefined | void;
export type StoredResourceScopeConfig = boolean | {
    /**
