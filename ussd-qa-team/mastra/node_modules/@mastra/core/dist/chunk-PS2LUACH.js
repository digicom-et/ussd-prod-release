import { MastraGateway, PROVIDER_REGISTRY, shouldEnableGateway, getGatewayId, findGatewayForModel } from './chunk-CXGM7OSM.js';
import { ModelsDevGateway, parseModelRouterId } from './chunk-5VSJH776.js';
import { NetlifyGateway } from './chunk-LVCGADQS.js';
import { createJsonErrorResponseHandler, lazyValidator, zodSchema, lazySchema, createProviderDefinedToolFactoryWithOutputSchema, MastraModelGateway, MASTRA_GATEWAY_STREAM_TRANSPORT, parseProviderOptions, postJsonToApi, createJsonResponseHandler, combineHeaders, generateId, createEventSourceResponseHandler, InvalidResponseDataError, isParsableJson, TooManyEmbeddingValuesForCallError, APICallError, convertBase64ToUint8Array, mediaTypeToExtension, postFormDataToApi, createBinaryResponseHandler, loadApiKey, withUserAgentSuffix, convertToBase64, UnsupportedFunctionalityError, InvalidPromptError, validateTypes, loadSetting, MASTRA_USER_AGENT } from './chunk-BQXT5IMT.js';
...
// ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/azure/2.0.108/e337a4e854f5f14549b2c4b694ea7f87c6b9285c131e86f3950198f851676d5f/node_modules/@ai-sdk/azure/dist/index.mjs
...
// src/llm/model/gateways/gateway-manager.ts
var MISSING_AUTH_ERROR_IDS = /* @__PURE__ */ new Set([
...
var GatewayManager = class _GatewayManager {
  gateways;
  ...
  static getPrefixForId(gatewayId, routerId) {
    const prefix = _GatewayManager.getPrefix(gatewayId);
  ...
  resolveModelId(routerId) {
    ...
    const { providerId, modelId } = parseModelRouterId(routerId, _GatewayManager.getPrefixForId(gatewayId, routerId));
  ...
  async resolveAuth(routerId) {
    ...
    const request = { gatewayId, providerId, modelId, routerId };
...
// src/llm/model/gateways/defaults.ts
...
export { AzureOpenAIGateway, GatewayManager, createOpenAIWebSocketFetch, defaultGateways };
//# sourceMappingURL=chunk-PS2LUACH.js.map
//# sourceMappingURL=chunk-PS2LUACH.js.map