...
var scoringSourceSchema = v4.z.enum(["LIVE", "TEST"]);
var scoringEntityTypeSchema = v4.z.enum([
  "AGENT",
  "WORKFLOW",
  "TRAJECTORY",
  "STEP",
  ...Object.values(chunkLP4WZA6D_cjs.SpanType)
]);
var scoringPromptsSchema = v4.z.object({
  description: v4.z.string(),
  prompt: v4.z.string()
});
var recordSchema = v4.z.record(v4.z.string(), v4.z.unknown());
var optionalRecordSchema = recordSchema.optional();
var scoringInputSchema = v4.z.object({
...
var scoringHookInputSchema = v4.z.object({
  runId: v4.z.string().optional(),
  scorer: recordSchema,
  input: v4.z.unknown(),
  output: v4.z.unknown(),
  ...
  requestContext: optionalRecordSchema,
  structuredOutput: v4.z.boolean().optional(),
...
var scoringValueSchema = v4.z.number();
var scoreResultSchema = v4.z.object({
...
var scoringInputWithExtractStepResultSchema = scoringInputSchema.extend({
  ...
  extractPrompt: v4.z.string().optional()
});
...
var scoringInputWithExtractStepResultAndScoreAndReasonSchema = scoringInputWithExtractStepResultAndAnalyzeStepResultSchema.extend({
  ...
  reasonPrompt: v4.z.string().optional()
});
var scoreRowDataSchema = v4.z.object({
  id: v4.z.string(),
...
var listScoresResponseSchema = v4.z.object({
  pagination: chunkLP4WZA6D_cjs.paginationInfoSchema,
...
var spanNameField = v4.z.string().describe("Human-readable span name");
var parentSpanIdField = v4.z.string().describe("Parent span reference (null = root span)");
var spanTypeField = v4.z.nativeEnum(chunkLP4WZA6D_cjs.SpanType).describe("Span type (e.g., WORKFLOW_RUN, AGENT_RUN, TOOL_CALL, etc.)");
var attributesField = v4.z.record(v4.z.string(), v4.z.unknown()).describe("Span-type specific attributes (e.g., model, tokens, tools)");
var linksField = v4.z.array(v4.z.unknown()).describe("References to related spans in other traces");
var inputField = v4.z.unknown().describe("Input data passed to the span");
var outputField = v4.z.unknown().describe("Output data returned from the span");
var errorField = v4.z.unknown().describe("Error info - presence indicates failure (status derived from this)");
var isEventField = v4.z.boolean().describe("Whether this is an event (point-in-time) vs a span (duration)");
var startedAtField = v4.z.date().describe("When the span started");
var endedAtField = v4.z.date().describe("When the span ended (null = running, status derived from this)");
...
var traceStatusField = v4.z.nativeEnum(TraceStatus).describe("Current status of the trace");
var hasChildErrorField = v4.z.preprocess((v) => {
  if (v === "true") return true;
  if (v === "false") return false;
  return v;
}, v4.z.boolean()).describe("True if any span in the trace encountered an error");
var sharedFields = {
  ...chunkLP4WZA6D_cjs.spanContextFields,
  metadata: chunkLP4WZA6D_cjs.metadataField.nullish(),
  tags: chunkLP4WZA6D_cjs.tagsField.nullish()
};
var spanIds = {
  traceId: chunkLP4WZA6D_cjs.traceIdField,
  spanId: chunkLP4WZA6D_cjs.spanIdField
};
var spanIdsSchema = v4.z.object({
  ...spanIds
});
var omitDbTimestamps = createOmitKeys(chunkLP4WZA6D_cjs.dbTimestamps);
var omitSpanIds = createOmitKeys(spanIds);
var spanRecordSchema = v4.z.object({
  ...
  ...sharedFields,
  // Experimentation
  experimentId: v4.z.string().nullish().describe("Experiment or eval run identifier"),
  ...
  requestContext: v4.z.record(v4.z.string(), v4.z.unknown()).nullish().describe("Request context data"),
  // Database timestamps
  ...chunkLP4WZA6D_cjs.dbTimestamps
...
var createSpanArgsSchema = v4.z.object({
  span: createSpanRecordSchema
}).describe("Arguments for creating a single span");
var batchCreateSpansArgsSchema = v4.z.object({
  records: v4.z.array(createSpanRecordSchema)
}).describe("Arguments for batch creating spans");
var getSpanArgsSchema = v4.z.object({
  traceId: chunkLP4WZA6D_cjs.traceIdField.min(1),
  spanId: chunkLP4WZA6D_cjs.spanIdField.min(1)
}).describe("Arguments for getting a single span");
var getSpanResponseSchema = v4.z.object({
  span: spanRecordSchema
});
var getSpansArgsSchema = v4.z.object({
  traceId: chunkLP4WZA6D_cjs.traceIdField.min(1),
  spanIds: v4.z.array(chunkLP4WZA6D_cjs.spanIdField.min(1)).min(1).describe("Span IDs to fetch within the trace")
}).describe("Arguments for batch-fetching spans by spanId within a trace");
var getSpansResponseSchema = v4.z.object({
  traceId: chunkLP4WZA6D_cjs.traceIdField,
  spans: v4.z.array(spanRecordSchema)
});
var getRootSpanArgsSchema = v4.z.object({
  traceId: chunkLP4WZA6D_cjs.traceIdField.min(1)
}).describe("Arguments for getting a root span");
var getRootSpanResponseSchema = v4.z.object({
  span: spanRecordSchema
});
var getTraceArgsSchema = v4.z.object({
  traceId: chunkLP4WZA6D_cjs.traceIdField.min(1)
}).describe("Arguments for getting a single trace");
var getTraceResponseSchema = v4.z.object({
  traceId: chunkLP4WZA6D_cjs.traceIdField,
  spans: v4.z.array(spanRecordSchema)
});
var getBranchArgsSchema = v4.z.object({
  traceId: chunkLP4WZA6D_cjs.traceIdField.min(1),
  spanId: chunkLP4WZA6D_cjs.spanIdField.min(1),
  depth: v4.z.coerce.number().int().min(0).optional().describe("Maximum descendant levels below the anchor span (omit for full subtree)")
}).describe("Arguments for getting a span branch (subtree rooted at a span)");
var getBranchResponseSchema = v4.z.object({
  traceId: chunkLP4WZA6D_cjs.traceIdField,
  spans: v4.z.array(spanRecordSchema)
});
function extractBranchSpans(spans, anchorSpanId, maxDepth) {
  ...
  const visited = /* @__PURE__ */ new Set([anchor.spanId]);
  const descendants = [];
  let frontier = [anchor];
  let depth = 0;
...
var lightSpanRecordSchema = v4.z.object({
  // Required identifiers
  ...spanIds,
  name: spanNameField,
  spanType: spanTypeField,
  ...
  entityType: chunkLP4WZA6D_cjs.spanContextFields.entityType,
  entityId: chunkLP4WZA6D_cjs.spanContextFields.entityId,
  entityName: chunkLP4WZA6D_cjs.spanContextFields.entityName,
  // Database timestamps
  ...chunkLP4WZA6D_cjs.dbTimestamps
}).describe(
  "Lightweight span record for timeline rendering (excludes input, output, attributes, metadata, tags, links)"
);
var getStructureResponseSchema = v4.z.object({
  traceId: chunkLP4WZA6D_cjs.traceIdField,
  spans: v4.z.array(lightSpanRecordSchema)
});
var getTraceLightResponseSchema = getStructureResponseSchema;
var tracesFilterSchema = v4.z.object({
  // Date range filters
  startedAt: chunkLP4WZA6D_cjs.dateRangeSchema.optional().describe("Filter by span start time range"),
  endedAt: chunkLP4WZA6D_cjs.dateRangeSchema.optional().describe("Filter by span end time range"),
  // Span type filter
  spanType: spanTypeField.optional(),
  // Identifier filter (matches the root span's trace identifier)
  traceId: chunkLP4WZA6D_cjs.traceIdField.optional().describe("Filter by trace ID (matches root span)"),
  // Shared fields
  ...sharedFields,
...
var tracesOrderByFieldSchema = v4.z.enum(["startedAt", "endedAt"]).describe("Field to order by: 'startedAt' | 'endedAt'");
var tracesOrderBySchema = v4.z.object({
  field: tracesOrderByFieldSchema.default("startedAt").describe("Field to order by"),
  direction: chunkLP4WZA6D_cjs.sortDirectionSchema.default("DESC").describe("Sort direction")
}).describe("Order by configuration");
var listTracesArgsSchema = v4.z.object({
  mode: chunkLP4WZA6D_cjs.listModeSchema.optional(),
  filters: tracesFilterSchema.optional().describe("Optional filters to apply"),
  pagination: chunkLP4WZA6D_cjs.paginationArgsSchema.optional(),
  orderBy: tracesOrderBySchema.optional(),
  after: chunkLP4WZA6D_cjs.deltaCursorSchema.optional(),
  limit: chunkLP4WZA6D_cjs.deltaLimitSchema
}).strict().superRefine(chunkLP4WZA6D_cjs.refineObservabilityListMode).transform(
  (value) => chunkLP4WZA6D_cjs.normalizeObservabilityListArgs(value, {
    orderBy: { field: "startedAt", direction: "DESC" }
  })
).describe("Arguments for listing traces.");
var listTracesResponseSchema = v4.z.object({
  pagination: chunkLP4WZA6D_cjs.paginationInfoSchema.optional(),
  delta: chunkLP4WZA6D_cjs.deltaInfoSchema.optional(),
  deltaCursor: chunkLP4WZA6D_cjs.deltaCursorSchema.optional(),
  spans: v4.z.array(traceSpanSchema)
});
var listTracesLightResponseSchema = v4.z.object({
  pagination: chunkLP4WZA6D_cjs.paginationInfoSchema,
  spans: v4.z.array(lightSpanRecordSchema)
});
var BRANCH_SPAN_TYPES = [
  "agent_run" /* AGENT_RUN */,
...
var branchesFilterSchema = v4.z.object({
  ...
  spanType: spanTypeField.optional(),
  // Identifier filters
  traceId: chunkLP4WZA6D_cjs.traceIdField.optional().describe("Filter by parent trace ID"),
...
var branchesOrderByFieldSchema = v4.z.enum(["startedAt", "endedAt"]).describe("Field to order by: 'startedAt' | 'endedAt'");
var branchesOrderBySchema = v4.z.object({
  field: branchesOrderByFieldSchema.default("startedAt").describe("Field to order by"),
  direction: chunkLP4WZA6D_cjs.sortDirectionSchema.default("DESC").describe("Sort direction")
}).describe("Order by configuration");
var listBranchesArgsSchema = v4.z.object({
  mode: chunkLP4WZA6D_cjs.listModeSchema.optional(),
  ...
  (value) => chunkLP4WZA6D_cjs.normalizeObservabilityListArgs(
    value,
    {
      orderBy: { field: "startedAt", direction: "DESC" }
    }
...
var listBranchesResponseSchema = v4.z.object({
  pagination: chunkLP4WZA6D_cjs.paginationInfoSchema.optional(),
  delta: chunkLP4WZA6D_cjs.deltaInfoSchema.optional(),
  deltaCursor: chunkLP4WZA6D_cjs.deltaCursorSchema.optional(),
  branches: v4.z.array(traceSpanSchema)
});
var updateSpanRecordSchema = createSpanRecordSchema.omit(omitSpanIds);
var updateSpanArgsSchema = v4.z.object({
  spanId: chunkLP4WZA6D_cjs.spanIdField,
  traceId: chunkLP4WZA6D_cjs.traceIdField,
  updates: updateSpanRecordSchema.partial()
}).describe("Arguments for updating a single span");
var batchUpdateSpansArgsSchema = v4.z.object({
  records: v4.z.array(
    v4.z.object({
      traceId: chunkLP4WZA6D_cjs.traceIdField,
      spanId: chunkLP4WZA6D_cjs.spanIdField,
...
var batchDeleteTracesArgsSchema = v4.z.object({
  traceIds: v4.z.array(chunkLP4WZA6D_cjs.traceIdField)
}).describe("Arguments for batch deleting traces");
var listScoresBySpanResponseSchema = v4.z.object({
  pagination: chunkLP4WZA6D_cjs.paginationInfoSchema,
  scores: v4.z.array(scoreRowDataSchema)
});
var scoreTracesRequestSchema = v4.z.object({
  scorerName: v4.z.string().min(1),
  targets: v4.z.array(
    v4.z.object({
      traceId: chunkLP4WZA6D_cjs.traceIdField,
      spanId: chunkLP4WZA6D_cjs.spanIdField.optional()
    })
  ).min(1)
});
var scoreTracesResponseSchema = v4.z.object({
  status: v4.z.string(),
  message: v4.z.string(),
  traceCount: v4.z.number()
});

// src/storage/types.ts
var STORAGE_VISIBILITY_VALUES = ["private", "public"];
function unwrapSchema(schema) {
  let current = schema;
  let nullable = false;
  while (true) {
    const typeName = chunkCMKSC37Z_cjs.getZodTypeName(current);
    if (!typeName) break;
    if (typeName === "ZodNullable" || typeName === "ZodOptional") {
      nullable = true;
    }
    const inner = chunkCMKSC37Z_cjs.getZodInnerType(current, typeName);
    if (!inner) break;
    current = inner;
  }
...
function zodToStorageType(schema) {
  const typeName = chunkCMKSC37Z_cjs.getZodTypeName(schema);
...
var STORAGE_FAVORITE_ENTITY_TYPES = ["agent", "skill"];
...
var TABLE_FAVORITES = "mastra_favorites";
...
var TABLE_BACKGROUND_TASKS = "mastra_background_tasks";
var TABLE_SCHEDULES = "mastra_schedules";
var TABLE_SCHEDULE_TRIGGERS = "mastra_schedule_triggers";
var TABLE_CHANNEL_INSTALLATIONS = "mastra_channel_installations";
var TABLE_CHANNEL_CONFIG = "mastra_channel_config";
var TABLE_TOOL_PROVIDER_CONNECTIONS = "mastra_tool_provider_connections";
var TABLE_NOTIFICATIONS = "mastra_notifications";
var TABLE_HARNESS_SESSIONS = "mastra_harness_sessions";
var TABLE_THREAD_STATE = "mastra_thread_state";
var SCORERS_SCHEMA = {
...
var AGENTS_SCHEMA = {
  ...
  // 'private' | 'public' | null (legacy)
  metadata: { type: "jsonb", nullable: true },
  // Additional metadata for the agent
  favoriteCount: { type: "integer", nullable: true },
  // Denormalised count of favorites for this agent
  createdAt: { type: "timestamp", nullable: false },
...
var SKILLS_SCHEMA = {
  ...
  // 'private' | 'public' | null (legacy)
  favoriteCount: { type: "integer", nullable: true },
  // Denormalised count of favorites for this skill
  createdAt: { type: "timestamp", nullable: false },
  updatedAt: { type: "timestamp", nullable: false }
};
var FAVORITES_SCHEMA = {
...
var TOOL_PROVIDER_CONNECTIONS_SCHEMA = {
...
exports.BRANCH_SPAN_TYPES = BRANCH_SPAN_TYPES;
exports.BRANCH_SPAN_TYPE_SET = BRANCH_SPAN_TYPE_SET;
...
exports.FAVORITES_SCHEMA = FAVORITES_SCHEMA;
exports.HARNESS_SESSIONS_SCHEMA = HARNESS_SESSIONS_SCHEMA;
...
exports.NOTIFICATIONS_SCHEMA = NOTIFICATIONS_SCHEMA;
...
exports.STORAGE_FAVORITE_ENTITY_TYPES = STORAGE_FAVORITE_ENTITY_TYPES;
exports.STORAGE_VISIBILITY_VALUES = STORAGE_VISIBILITY_VALUES;
exports.TABLE_AGENTS = TABLE_AGENTS;
exports.TABLE_AGENT_VERSIONS = TABLE_AGENT_VERSIONS;
exports.TABLE_BACKGROUND_TASKS = TABLE_BACKGROUND_TASKS;
exports.TABLE_CHANNEL_CONFIG = TABLE_CHANNEL_CONFIG;
exports.TABLE_CHANNEL_INSTALLATIONS = TABLE_CHANNEL_INSTALLATIONS;
...
exports.TABLE_FAVORITES = TABLE_FAVORITES;
exports.TABLE_HARNESS_SESSIONS = TABLE_HARNESS_SESSIONS;
...
exports.TABLE_NOTIFICATIONS = TABLE_NOTIFICATIONS;
...
exports.TABLE_SCHEDULES = TABLE_SCHEDULES;
exports.TABLE_SCHEDULE_TRIGGERS = TABLE_SCHEDULE_TRIGGERS;
...
exports.TABLE_THREAD_STATE = TABLE_THREAD_STATE;
exports.TABLE_TOOL_PROVIDER_CONNECTIONS = TABLE_TOOL_PROVIDER_CONNECTIONS;
...
exports.THREAD_STATE_SCHEMA = THREAD_STATE_SCHEMA;
exports.TOOL_PROVIDER_CONNECTIONS_SCHEMA = TOOL_PROVIDER_CONNECTIONS_SCHEMA;
...
exports.branchesFilterSchema = branchesFilterSchema;
exports.branchesOrderByFieldSchema = branchesOrderByFieldSchema;
exports.branchesOrderBySchema = branchesOrderBySchema;
...
exports.extractBranchSpans = extractBranchSpans;
...
exports.getBranchArgsSchema = getBranchArgsSchema;
exports.getBranchResponseSchema = getBranchResponseSchema;
...
exports.getSpansArgsSchema = getSpansArgsSchema;
exports.getSpansResponseSchema = getSpansResponseSchema;
exports.getStructureResponseSchema = getStructureResponseSchema;
exports.getTraceArgsSchema = getTraceArgsSchema;
exports.getTraceLightResponseSchema = getTraceLightResponseSchema;
exports.getTraceResponseSchema = getTraceResponseSchema;
exports.lightSpanRecordSchema = lightSpanRecordSchema;
exports.listBranchesArgsSchema = listBranchesArgsSchema;
...
exports.listTracesLightResponseSchema = listTracesLightResponseSchema;
...
//# sourceMappingURL=chunk-3I6MKYQG.cjs.map
//# sourceMappingURL=chunk-3I6MKYQG.cjs.map