import { MastraA2AError } from '../chunk-O2CHMYVQ.js';
export { MastraA2AError } from '../chunk-O2CHMYVQ.js';
import { MessageList, convertMessages } from '../chunk-FDU3KNKR.js';
...
function createResponseMessages(text, memoryInfo = {}) {
  ...
  return new MessageList(memoryInfo).add(
    {
      role: "assistant",
      content: text
    },
