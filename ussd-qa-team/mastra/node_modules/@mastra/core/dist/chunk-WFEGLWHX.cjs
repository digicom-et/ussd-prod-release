...
function prepareTools({
  ...
  switch (type) {
    ...
    default: {
      ...
      throw new chunkA45A2T7R_cjs.UnsupportedFunctionalityError2({
...
var alibabaFailedResponseHandler = chunkA45A2T7R_cjs.createJsonErrorResponseHandler2({
...
function formatImageUrl({
  ...
  return data instanceof URL ? data.toString() : `data:${mediaType};base64,${chunkA45A2T7R_cjs.convertToBase642(data)}`;
}
...
var AlibabaLanguageModel = class {
  ...
  async getArgs({
    ...
    const alibabaOptions = await chunkA45A2T7R_cjs.parseProviderOptions2({
      provider: "alibaba",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    } = await chunkA45A2T7R_cjs.postJsonToApi2({
      url: `${this.config.baseURL}/chat/completions`,
      headers: chunkA45A2T7R_cjs.combineHeaders2(this.config.headers(), options.headers),
      body: args,
      failedResponseHandler: alibabaFailedResponseHandler,
      successfulResponseHandler: chunkA45A2T7R_cjs.createJsonResponseHandler2(
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkA45A2T7R_cjs.postJsonToApi2({
      url: `${this.config.baseURL}/chat/completions`,
      headers: chunkA45A2T7R_cjs.combineHeaders2(this.config.headers(), options.headers),
      body,
      failedResponseHandler: alibabaFailedResponseHandler,
      successfulResponseHandler: chunkA45A2T7R_cjs.createEventSourceResponseHandler2(
          ...
          transform(chunk, controller) {
            ...
            if (delta.reasoning_content != null && delta.reasoning_content.length > 0) {
              if (activeReasoningId == null) {
                ...
                activeReasoningId = chunkA45A2T7R_cjs.generateId2();
                controller.enqueue({
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.id == null) {
                    throw new chunkA45A2T7R_cjs.InvalidResponseDataError2({
                      data: toolCallDelta,
                  ...
                  if (chunkA45A2T7R_cjs.isParsableJson2(toolCall2.function.arguments)) {
                    controller.enqueue({
                      type: "tool-input-end",
                      id: toolCall2.id
                    });
                ...
                if (chunkA45A2T7R_cjs.isParsableJson2(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
...
var alibabaVideoModelOptionsSchema = chunkA45A2T7R_cjs.lazySchema2(
  () => chunkA45A2T7R_cjs.zodSchema2(
    v4.z.object({
...
var alibabaVideoFailedResponseHandler = chunkA45A2T7R_cjs.createJsonErrorResponseHandler2({
  ...
  async doGenerate(options) {
    ...
    if (mode === "i2v" && options.image != null) {
      if (options.image.type === "url") {
        ...
        const base64Data = typeof options.image.data === "string" ? options.image.data : chunkA45A2T7R_cjs.convertUint8ArrayToBase642(options.image.data);
    ...
    const { value: createResponse } = await chunkA45A2T7R_cjs.postJsonToApi2({
      url: `${this.config.baseURL}/api/v1/services/aigc/video-generation/video-synthesis`,
      headers: chunkA45A2T7R_cjs.combineHeaders2(
        await chunkA45A2T7R_cjs.resolve2(this.config.headers),
        options.headers,
        {
    ...
    if (!taskId) {
      throw new chunkA45A2T7R_cjs.AISDKError({
    ...
    let responseHeaders;
    while (true) {
      await chunkA45A2T7R_cjs.delay(pollIntervalMs, { abortSignal: options.abortSignal });
      ...
      const { value: statusResponse, responseHeaders: pollHeaders } = await chunkA45A2T7R_cjs.getFromApi({
...
function createAlibaba(options = {}) {
  var _a15, _b;
  const baseURL = (_a15 = chunkA45A2T7R_cjs.withoutTrailingSlash2(options.baseURL)) != null ? _a15 : "https://dashscope-intl.aliyuncs.com/compatible-mode/v1";
  const videoBaseURL = (_b = chunkA45A2T7R_cjs.withoutTrailingSlash2(options.videoBaseURL)) != null ? _b : "https://dashscope-intl.aliyuncs.com";
  const getHeaders = () => chunkA45A2T7R_cjs.withUserAgentSuffix2(
    {
      Authorization: `Bearer ${chunkA45A2T7R_cjs.loadApiKey2({
  ...
  provider.imageModel = (modelId) => {
    throw new chunkA45A2T7R_cjs.NoSuchModelError2({ modelId, modelType: "imageModel" });
  };
  provider.embeddingModel = (modelId) => {
    throw new chunkA45A2T7R_cjs.NoSuchModelError2({ modelId, modelType: "embeddingModel" });
  };
  return provider;
}
createAlibaba();
...
function createCerebras(options = {}) {
  var _a15;
  const baseURL = chunkA45A2T7R_cjs.withoutTrailingSlash(
  ...
  const createLanguageModel = (modelId) => {
    return new chunkA45A2T7R_cjs.OpenAICompatibleChatLanguageModel(modelId, {
  ...
  provider.textEmbeddingModel = (modelId) => {
    throw new chunkA45A2T7R_cjs.NoSuchModelError({ modelId, modelType: "textEmbeddingModel" });
  };
  provider.imageModel = (modelId) => {
    throw new chunkA45A2T7R_cjs.NoSuchModelError({ modelId, modelType: "imageModel" });
  };
  return provider;
}
createCerebras();
var DeepInfraImageModel = class {
  ...
  async doGenerate({
    ...
    const { value: response, responseHeaders } = await chunkA45A2T7R_cjs.postJsonToApi({
      ...
      failedResponseHandler: chunkA45A2T7R_cjs.createJsonErrorResponseHandler({
...
var DeepInfraChatLanguageModel = class extends chunkA45A2T7R_cjs.OpenAICompatibleChatLanguageModel {
  constructor(modelId, config) {
...
function createDeepInfra(options = {}) {
  ...
  const createCompletionModel = (modelId) => new chunkA45A2T7R_cjs.OpenAICompatibleCompletionLanguageModel(
    modelId,
    getCommonModelConfig("completion")
  );
  const createTextEmbeddingModel = (modelId) => new chunkA45A2T7R_cjs.OpenAICompatibleEmbeddingModel(
    modelId,
...
var deepseekChatChunkSchema = chunkA45A2T7R_cjs.lazySchema(
...
var DeepSeekChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.failedResponseHandler = chunkA45A2T7R_cjs.createJsonErrorResponseHandler({
  ...
  async getArgs({
    ...
    var _a15, _b;
    const deepseekOptions = (_a15 = await chunkA45A2T7R_cjs.parseProviderOptions({
  ...
  async doGenerate(options) {
    ...
    if (choice.message.tool_calls != null) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_a15 = toolCall.id) != null ? _a15 : chunkA45A2T7R_cjs.generateId(),
          toolName: toolCall.function.name,
          input: toolCall.function.arguments
        });
      }
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (((_c = toolCall2.function) == null ? void 0 : _c.name) != null && ((_d = toolCall2.function) == null ? void 0 : _d.arguments) != null) {
                    ...
                    if (chunkA45A2T7R_cjs.isParsableJson(toolCall2.function.arguments)) {
                      ...
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_e = toolCall2.id) != null ? _e : chunkA45A2T7R_cjs.generateId(),
                        toolName: toolCall2.function.name,
                        input: toolCall2.function.arguments
                      });
                      toolCall2.hasFinished = true;
                ...
                if (((_j = toolCall.function) == null ? void 0 : _j.name) != null && ((_k = toolCall.function) == null ? void 0 : _k.arguments) != null && chunkA45A2T7R_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_l = toolCall.id) != null ? _l : chunkA45A2T7R_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
                  toolCall.hasFinished = true;
            ...
            switch (part.type) {
              ...
              case "file": {
                ...
                return {
                  type: "image_url",
                  image_url: {
                    url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunkA45A2T7R_cjs.convertToBase642(part.data)}`
                  }
                };
              }
            }
...
var groqFailedResponseHandler = chunkA45A2T7R_cjs.createJsonErrorResponseHandler2({
...
var GroqChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a15, _b, _c;
    const warnings = [];
    const groqOptions = await chunkA45A2T7R_cjs.parseProviderOptions2({
      provider: "groq",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    if (choice.message.tool_calls != null) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_a15 = toolCall.id) != null ? _a15 : chunkA45A2T7R_cjs.generateId2(),
          toolName: toolCall.function.name,
          input: toolCall.function.arguments
        });
      }
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkA45A2T7R_cjs.postJsonToApi2({
      ...
      failedResponseHandler: groqFailedResponseHandler,
      successfulResponseHandler: chunkA45A2T7R_cjs.createEventSourceResponseHandler2(groqChatChunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    const toolCalls = [];
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (((_d = toolCall2.function) == null ? void 0 : _d.name) != null && ((_e = toolCall2.function) == null ? void 0 : _e.arguments) != null) {
                    ...
                    if (chunkA45A2T7R_cjs.isParsableJson2(toolCall2.function.arguments)) {
                      ...
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_f = toolCall2.id) != null ? _f : chunkA45A2T7R_cjs.generateId2(),
                        toolName: toolCall2.function.name,
                        input: toolCall2.function.arguments
                      });
                      toolCall2.hasFinished = true;
                ...
                if (((_k = toolCall.function) == null ? void 0 : _k.name) != null && ((_l = toolCall.function) == null ? void 0 : _l.arguments) != null && chunkA45A2T7R_cjs.isParsableJson2(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_m = toolCall.id) != null ? _m : chunkA45A2T7R_cjs.generateId2(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
                  toolCall.hasFinished = true;
...
var groqTranscriptionModelOptions = chunkA45A2T7R_cjs.lazySchema2(
  () => chunkA45A2T7R_cjs.zodSchema2(
    v4.z.object({
...
var GroqTranscriptionModel = class {
  ...
  async getArgs({
    ...
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunkA45A2T7R_cjs.convertBase64ToUint8Array2(audio)]);
    formData.append("model", this.modelId);
    const fileExtension = chunkA45A2T7R_cjs.mediaTypeToExtension2(mediaType);
    formData.append(
      "file",
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunkA45A2T7R_cjs.postFormDataToApi2({
      url: this.config.url({
...
var browserSearch = chunkA45A2T7R_cjs.createProviderToolFactory({
...
function createGroq(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunkA45A2T7R_cjs.withoutTrailingSlash2(options.baseURL)) != null ? _a15 : "https://api.groq.com/openai/v1";
  const getHeaders = () => chunkA45A2T7R_cjs.withUserAgentSuffix2(
    {
      Authorization: `Bearer ${chunkA45A2T7R_cjs.loadApiKey2({
        apiKey: options.apiKey,
...
var mistralFailedResponseHandler = chunkA45A2T7R_cjs.createJsonErrorResponseHandler2({
...
var MistralChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a15 = config.generateId) != null ? _a15 : chunkA45A2T7R_cjs.generateId2;
  }
  get provider() {
    return this.config.provider;
  }
  async getArgs({
    ...
    var _a15, _b, _c, _d;
    const warnings = [];
    const options = (_a15 = await chunkA45A2T7R_cjs.parseProviderOptions2({
      provider: "mistral",
      providerOptions,
    ...
    if ((responseFormat == null ? void 0 : responseFormat.type) === "json" && !(responseFormat == null ? void 0 : responseFormat.schema)) {
      prompt = chunkA45A2T7R_cjs.injectJsonInstructionIntoMessages({
        messages: prompt,
        schema: responseFormat.schema
      });
    }
...
var MistralEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunkA45A2T7R_cjs.TooManyEmbeddingValuesForCallError2({
    ...
    const {
      ...
      headers: chunkA45A2T7R_cjs.combineHeaders2(this.config.headers(), headers),
      body: {
        model: this.modelId,
        input: values,
...
function createMistral(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunkA45A2T7R_cjs.withoutTrailingSlash2(options.baseURL)) != null ? _a15 : "https://api.mistral.ai/v1";
  const getHeaders = () => chunkA45A2T7R_cjs.withUserAgentSuffix2(
    {
      Authorization: `Bearer ${chunkA45A2T7R_cjs.loadApiKey2({
        apiKey: options.apiKey,
            ...
            case "file": {
              if (part.mediaType === "application/pdf") {
                return part.data instanceof URL ? {
                  ...
                  type: "file_url",
                  file_url: {
                    url: typeof part.data === "string" ? part.data : chunkA45A2T7R_cjs.convertUint8ArrayToBase64(part.data)
                  },
                ...
                return part.data instanceof URL ? {
                  ...
                  type: "image_url",
                  image_url: {
                    url: `data:${(_a15 = part.mediaType) != null ? _a15 : "image/jpeg"};base64,${typeof part.data === "string" ? part.data : chunkA45A2T7R_cjs.convertUint8ArrayToBase64(part.data)}`
                  }
                };
              }
            }
...
function createPerplexity(options = {}) {
  ...
  const createLanguageModel = (modelId) => {
    ...
    return new PerplexityLanguageModel(modelId, {
      baseURL: chunkA45A2T7R_cjs.withoutTrailingSlash(
        (_a15 = options.baseURL) != null ? _a15 : "https://api.perplexity.ai"
      ),
      headers: getHeaders,
      generateId: chunkA45A2T7R_cjs.generateId,
      fetch: options.fetch
    });
  };
  const provider = (modelId) => createLanguageModel(modelId);
...
function createTogetherAI(options = {}) {
  ...
  const getHeaders = () => {
    var _a22;
    return chunkA45A2T7R_cjs.withUserAgentSuffix(
      {
        Authorization: `Bearer ${chunkA45A2T7R_cjs.loadApiKey({
  ...
  const createChatModel = (modelId) => {
    return new chunkA45A2T7R_cjs.OpenAICompatibleChatLanguageModel(
      modelId,
      getCommonModelConfig("chat")
    );
  };
...
var xaiFailedResponseHandler = chunkA45A2T7R_cjs.createJsonErrorResponseHandler2({
...
var XaiChatLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    if (response.error != null) {
      throw new chunkA45A2T7R_cjs.APICallError2({
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkA45A2T7R_cjs.postJsonToApi2({
      ...
      successfulResponseHandler: async ({ response: response2 }) => {
        const responseHeaders2 = chunkA45A2T7R_cjs.extractResponseHeaders(response2);
        const contentType = response2.headers.get("content-type");
        if (contentType == null ? void 0 : contentType.includes("application/json")) {
          const responseBody = await response2.text();
          const parsedError = await chunkA45A2T7R_cjs.safeParseJSON({
            text: responseBody,
        ...
        return chunkA45A2T7R_cjs.createEventSourceResponseHandler2(xaiChatChunkSchema)({
          response: response2,
          url,
          requestBodyValues: body
        });
...
var XaiImageModel = class {
  ...
  async doGenerate({
    ...
    const xaiOptions = await chunkA45A2T7R_cjs.parseProviderOptions2({
      provider: "xai",
      providerOptions,
      schema: xaiImageModelOptions
    });
    const hasFiles = files != null && files.length > 0;
    const imageUrls = hasFiles ? files.map((file) => chunkA45A2T7R_cjs.convertImageModelFileToDataUri(file)) : [];
    ...
    const { value: response, responseHeaders } = await chunkA45A2T7R_cjs.postJsonToApi2({
  ...
  async downloadImage(url, abortSignal) {
    const { value } = await chunkA45A2T7R_cjs.getFromApi({
      url,
      abortSignal,
      failedResponseHandler: chunkA45A2T7R_cjs.createStatusCodeErrorResponseHandler(),
      successfulResponseHandler: chunkA45A2T7R_cjs.createBinaryResponseHandler2(),
      fetch: this.config.fetch
    });
    return value;
  }
          ...
          switch (block.type) {
            ...
            case "file": {
              if (block.mediaType.startsWith("image/")) {
                ...
                const imageUrl = block.data instanceof URL ? block.data.toString() : `data:${mediaType};base64,${chunkA45A2T7R_cjs.convertToBase642(block.data)}`;
...
var fileSearchArgsSchema = chunkA45A2T7R_cjs.lazySchema2(
  () => chunkA45A2T7R_cjs.zodSchema2(
    v4.z.object({
...
var fileSearchOutputSchema = chunkA45A2T7R_cjs.lazySchema2(
  () => chunkA45A2T7R_cjs.zodSchema2(
    v4.z.object({
...
var fileSearchToolFactory = chunkA45A2T7R_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.file_search",
  inputSchema: chunkA45A2T7R_cjs.lazySchema2(() => chunkA45A2T7R_cjs.zodSchema2(v4.z.object({}))),
  outputSchema: fileSearchOutputSchema
});
var fileSearch = (args) => fileSearchToolFactory(args);
var mcpServerArgsSchema = chunkA45A2T7R_cjs.lazySchema2(
  () => chunkA45A2T7R_cjs.zodSchema2(
    v4.z.object({
...
var mcpServerOutputSchema = chunkA45A2T7R_cjs.lazySchema2(
  () => chunkA45A2T7R_cjs.zodSchema2(
    v4.z.object({
      name: v4.z.string(),
      arguments: v4.z.string(),
...
var mcpServerToolFactory = chunkA45A2T7R_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.mcp",
  inputSchema: chunkA45A2T7R_cjs.lazySchema2(() => chunkA45A2T7R_cjs.zodSchema2(v4.z.object({}))),
  outputSchema: mcpServerOutputSchema
});
var mcpServer = (args) => mcpServerToolFactory(args);
var webSearchArgsSchema = chunkA45A2T7R_cjs.lazySchema2(
  () => chunkA45A2T7R_cjs.zodSchema2(
    v4.z.object({
...
var webSearchOutputSchema = chunkA45A2T7R_cjs.lazySchema2(
  () => chunkA45A2T7R_cjs.zodSchema2(
    v4.z.object({
      query: v4.z.string(),
      sources: v4.z.array(
...
var webSearchToolFactory = chunkA45A2T7R_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.web_search",
  inputSchema: chunkA45A2T7R_cjs.lazySchema2(() => chunkA45A2T7R_cjs.zodSchema2(v4.z.object({}))),
  outputSchema: webSearchOutputSchema
});
var webSearch = (args = {}) => webSearchToolFactory(args);
var xSearchArgsSchema = chunkA45A2T7R_cjs.lazySchema2(
  () => chunkA45A2T7R_cjs.zodSchema2(
    v4.z.object({
...
var xSearchOutputSchema = chunkA45A2T7R_cjs.lazySchema2(
  () => chunkA45A2T7R_cjs.zodSchema2(
    v4.z.object({
      query: v4.z.string(),
      posts: v4.z.array(
...
var xSearchToolFactory = chunkA45A2T7R_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.x_search",
  inputSchema: chunkA45A2T7R_cjs.lazySchema2(() => chunkA45A2T7R_cjs.zodSchema2(v4.z.object({}))),
...
async function prepareResponsesTools({
  ...
  for (const tool of normalizedTools) {
    ...
    if (tool.type === "provider") {
      switch (tool.id) {
        case "xai.web_search": {
          const args = await chunkA45A2T7R_cjs.validateTypes2({
            value: tool.args,
...
var codeExecutionToolFactory = chunkA45A2T7R_cjs.createProviderToolFactoryWithOutputSchema({
...
var viewImageToolFactory = chunkA45A2T7R_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.view_image",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
var viewXVideoToolFactory = chunkA45A2T7R_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.view_x_video",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
var xaiVideoModelOptionsSchema = chunkA45A2T7R_cjs.lazySchema2(
  () => chunkA45A2T7R_cjs.zodSchema2(runtimeSchema)
);
var RESOLUTION_MAP = {
  "1280x720": "720p",
  "854x480": "480p",
...
function createXai(options = {}) {
  var _a15;
  const baseURL = chunkA45A2T7R_cjs.withoutTrailingSlash2(
  ...
  const createChatLanguageModel = (modelId) => {
    return new XaiChatLanguageModel(modelId, {
      ...
      baseURL,
      headers: getHeaders,
      generateId: chunkA45A2T7R_cjs.generateId2,
      fetch: options.fetch
    });
  };
...
var ModelsDevGateway = class extends chunkA45A2T7R_cjs.MastraModelGateway {
  id = "models.dev";
  name = "models.dev";
  providerConfigs = {};
  ...
  async fetchProviders() {
    ...
    for (const [providerId, providerInfo] of Object.entries(data)) {
      if (chunkA45A2T7R_cjs.EXCLUDED_PROVIDERS.includes(providerId)) continue;
      ...
      const hasInstalledPackage = chunkA45A2T7R_cjs.PROVIDERS_WITH_INSTALLED_PACKAGES.includes(providerId);
  ...
  async resolveLanguageModel({
    ...
    switch (providerId) {
      ...
      case "gemini":
      case "google":
        return chunkA45A2T7R_cjs.createGoogleGenerativeAI({ apiKey, baseURL, headers: mastraHeaders }).chat(modelId);
      case "anthropic":
        return chunkA45A2T7R_cjs.createAnthropic({ apiKey, baseURL, headers: mastraHeaders })(modelId);
      case "mistral":
      ...
      default: {
        ...
        if (npm === "@ai-sdk/openai") {
          if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
          return chunkA45A2T7R_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).chat(modelId);
        }
...
//# sourceMappingURL=chunk-WFEGLWHX.cjs.map
//# sourceMappingURL=chunk-WFEGLWHX.cjs.map