...
// ../_internals/auth/dist/chunk-BHFQZXOC.js
...
var EE_TELEMETRY_BRIDGE = /* @__PURE__ */ Symbol.for("mastra.eeTelemetryBridge");
...
var hasWarnedAboutDevLicense = false;
function getClient() {
...
function validateLicense(licenseKey) {
  ...
  if (licenseKey !== void 0 && licenseKey !== configuredKey) {
    return { valid: false };
  }
...
// ../_internals/auth/dist/chunk-GVS7OL46.js
var RESOURCES = [
  "a2a",
  "agent-builder",
  "agent-controller",
...
var ACTIONS = ["create", "delete", "execute", "publish", "read", "share", "write"];
...
var StaticRBACProvider = class {
  ...
  async getAvailableRoles() {
    ...
    if (this._roleMapping) {
      return Object.keys(this._roleMapping).filter((k) => k !== "_default").map((k) => ({ id: k, name: k }));
    }
    return [];
  }
  /**
...
exports.FGADeniedError = FGADeniedError;
exports.MastraFGAPermissions = MastraFGAPermissions;
exports.PERMISSIONS = PERMISSIONS;
exports.PERMISSION_PATTERNS = PERMISSION_PATTERNS;
exports.RESOURCES = RESOURCES;
exports.StaticRBACProvider = StaticRBACProvider;
exports.buildCapabilities = buildCapabilities;
exports.checkFGA = checkFGA;
exports.clearLicenseCache = clearLicenseCache;
exports.getAgentFGAResourceId = getAgentFGAResourceId;
exports.getAgentToolFGAResourceId = getAgentToolFGAResourceId;
exports.getDefaultRole = getDefaultRole;
exports.getMCPToolFGAResourceId = getMCPToolFGAResourceId;
exports.getSafeLicenseSummary = getSafeLicenseSummary;
exports.getStandaloneToolFGAResourceId = getStandaloneToolFGAResourceId;
exports.getWorkflowFGAResourceId = getWorkflowFGAResourceId;
exports.hasPermission = hasPermission;
exports.isAuthenticated = isAuthenticated;
exports.isDevEnvironment = isDevEnvironment;
exports.isEEEnabled = isEEEnabled;
exports.isEELicenseValid = isEELicenseValid;
exports.isFeatureEnabled = isFeatureEnabled;
exports.isLicenseValid = isLicenseValid;
exports.isValidPermissionPattern = isValidPermissionPattern;
exports.matchesPermission = matchesPermission;
exports.requireFGA = requireFGA;
exports.resolvePermissions = resolvePermissions;
exports.resolvePermissionsFromMapping = resolvePermissionsFromMapping;
exports.startLicenseValidation = startLicenseValidation;
exports.validateLicense = validateLicense;
exports.validatePermissions = validatePermissions;
exports.warnIfDevEENeedsLicense = warnIfDevEENeedsLicense;
//# sourceMappingURL=chunk-W7RLUWK5.cjs.map
//# sourceMappingURL=chunk-W7RLUWK5.cjs.map