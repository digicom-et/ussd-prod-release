import { ModelsDevGateway, createOpenRouter } from './chunk-5VSJH776.js';
import { NetlifyGateway } from './chunk-LVCGADQS.js';
import { MastraModelGateway, createAnthropic, MASTRA_USER_AGENT, GATEWAY_AUTH_HEADER } from './chunk-BQXT5IMT.js';
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-WMBLPVEH.js');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-3PWHCEFX.js');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-34ANSLN6.js');
      const { fetchProvidersFromGateways, writeRegistryFiles } = await import('./registry-generator-AXFE3YQ5.js');
...
export { GatewayRegistry, MastraGateway, PROVIDER_MODELS, PROVIDER_REGISTRY, findGatewayForModel, getGatewayId, getProviderConfig, getRegisteredProviders, isOfflineMode, isProviderRegistered, isValidModelId, modelSupportsAttachments, parseModelString, shouldEnableGateway };
//# sourceMappingURL=chunk-CXGM7OSM.js.map
//# sourceMappingURL=chunk-CXGM7OSM.js.map