...
function dbMessagesToStateSignals(messages, stateId, threadId) {
  return sortStateSignals(
    messages.filter((message) => message.role === "signal").map((message) => {
      try {
        return chunkDC5C6QMM_cjs.mastraDBMessageToSignal(message);
      } catch {
        return void 0;
      }
    }).filter(
...
async function applyStateSignal({
  ...
  const updatedSignal = chunkDC5C6QMM_cjs.createSignal({
    ...signal,
    metadata: {
      ...signal.metadata,
      state: {
...
//# sourceMappingURL=chunk-CAGRA5LK.cjs.map
//# sourceMappingURL=chunk-CAGRA5LK.cjs.map