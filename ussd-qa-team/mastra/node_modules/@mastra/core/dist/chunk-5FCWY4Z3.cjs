...
// src/llm/model/gateways/gateway-helpers.ts
...
var provider_registry_default = {
  providers: {
    ...
    "alibaba-token-plan-cn": {
      ...
      apiKeyEnvVar: "ALIBABA_TOKEN_PLAN_API_KEY",
      apiKeyHeader: "Authorization",
      ...
      docUrl: "https://www.alibabacloud.com/help/zh/model-studio/token-plan-overview",
      gateway: "models.dev"
    },
    moonshotai: {
    ...
    subconscious: {
      ...
      apiKeyEnvVar: "SUBCONSCIOUS_API_KEY",
      apiKeyHeader: "Authorization",
      name: "Subconscious",
      models: ["subconscious/tim-qwen3.6-27b"],
      docUrl: "https://docs.subconscious.dev",
      gateway: "models.dev"
    },
    lmstudio: {
    ...
    poolside: {
      ...
      docUrl: "https://platform.poolside.ai",
      gateway: "models.dev"
    },
    zenmux: {
    ...
    "snowflake-cortex": {
      ...
      apiKeyEnvVar: "SNOWFLAKE_CORTEX_PAT",
      apiKeyHeader: "Authorization",
      ...
      docUrl: "https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-rest-api",
      gateway: "models.dev"
    },
    "github-models": {
    ...
    sakana: {
      ...
      docUrl: "https://console.sakana.ai/models",
      gateway: "models.dev"
    },
    deepinfra: {
    ...
    freemodel: {
      ...
      apiKeyEnvVar: "FREEMODEL_API_KEY",
      apiKeyHeader: "Authorization",
      name: "FreeModel",
      models: [
        "claude-fable-5",
    ...
    llmtr: {
      ...
      apiKeyEnvVar: "LLMTR_API_KEY",
      apiKeyHeader: "Authorization",
      name: "LLMTR",
      models: ["gemma-4", "magibu-11b-v8", "medgemma-4b", "qwen3-6-35b", "sincap", "trendyol-7b"],
      docUrl: "https://llmtr.com/docs",
      gateway: "models.dev"
    },
    sarvam: {
    ...
    stepfun: {
      ...
      apiKeyHeader: "Authorization",
      name: "StepFun",
      models: ["step-1-32k", "step-2-16k", "step-3.5-flash", "step-3.5-flash-2603", "step-3.7-flash"],
    ...
    "kimi-for-coding": {
      ...
      models: ["k2p5", "k2p6", "k2p7", "kimi-k2-thinking"],
      docUrl: "https://www.kimi.com/code/docs/en/third-party-tools/other-coding-agents.html",
      gateway: "models.dev",
      npm: "@ai-sdk/anthropic"
    },
    dinference: {
    ...
    zeldoc: {
      ...
      apiKeyEnvVar: "ZELDOC_API_KEY",
      apiKeyHeader: "Authorization",
      name: "Zeldoc",
      models: ["z-code"],
      docUrl: "https://docs.zeldoc.ai",
      gateway: "models.dev"
    },
    scaleway: {
    ...
    lucidquery: {
      ...
      docUrl: "https://lucidquery.com/docs",
      gateway: "models.dev"
    },
    meganova: {
    ...
    "umans-ai": {
      url: "https://api.code.umans.ai/v1",
      apiKeyEnvVar: "UMANS_AI_API_KEY",
      apiKeyHeader: "Authorization",
      name: "Umans AI",
      models: ["umans-coder", "umans-flash", "umans-glm-5.1", "umans-glm-5.2", "umans-kimi-k2.7"],
      docUrl: "https://app.umans.ai/offers/code/docs/orgs",
      gateway: "models.dev"
    },
    togetherai: {
    ...
    "alibaba-token-plan": {
      ...
      docUrl: "https://www.alibabacloud.com/help/en/model-studio/token-plan-overview",
      gateway: "models.dev"
    },
    alibaba: {
    ...
    xpersona: {
      ...
      apiKeyHeader: "Authorization",
      name: "Xpersona",
      models: ["xpersona-frieren-coder", "xpersona-gpt-5.5"],
    ...
    lilac: {
      ...
      apiKeyHeader: "Authorization",
      name: "Lilac",
      models: ["google/gemma-4-31b-it", "minimaxai/minimax-m3", "moonshotai/kimi-k2.6", "zai-org/glm-5.2"],
    ...
    ambient: {
      ...
      apiKeyHeader: "Authorization",
      name: "Ambient",
      models: ["moonshotai/kimi-k2.6", "moonshotai/kimi-k2.7-code", "zai-org/GLM-5.1-FP8"],
    ...
    "zhipuai-coding-plan": {
      ...
      models: ["glm-4.5-air", "glm-4.6v", "glm-4.7", "glm-5-turbo", "glm-5.1", "glm-5.2", "glm-5v-turbo"],
  ...
  models: {
    ...
    poolside: ["poolside/laguna-m.1", "poolside/laguna-xs.2"],
    zenmux: [
      "anthropic/claude-3.5-haiku",
      "anthropic/claude-3.7-sonnet",
      "anthropic/claude-fable-5",
    ...
    "zai-coding-plan": ["glm-4.5-air", "glm-4.7", "glm-5-turbo", "glm-5.1", "glm-5.2", "glm-5v-turbo"],
    nvidia: [
      "abacusai/dracarys-llama-3_1-70b-instruct",
      "baai/bge-m3",
      "black-forest-labs/flux.1-dev",
    ...
    xiaomi: ["mimo-v2.5", "mimo-v2.5-pro", "mimo-v2.5-pro-ultraspeed"],
    ...
    llmtr: ["gemma-4", "magibu-11b-v8", "medgemma-4b", "qwen3-6-35b", "sincap", "trendyol-7b"],
    sarvam: ["sarvam-105b", "sarvam-30b"],
    stepfun: ["step-1-32k", "step-2-16k", "step-3.5-flash", "step-3.5-flash-2603", "step-3.7-flash"],
    ...
    "kimi-for-coding": ["k2p5", "k2p6", "k2p7", "kimi-k2-thinking"],
    ...
    "umans-ai": ["umans-coder", "umans-flash", "umans-glm-5.1", "umans-glm-5.2", "umans-kimi-k2.7"],
    togetherai: [
      "LiquidAI/LFM2-24B-A2B",
      "MiniMaxAI/MiniMax-M2.7",
      "MiniMaxAI/MiniMax-M3",
    ...
    xpersona: ["xpersona-frieren-coder", "xpersona-gpt-5.5"],
    baseten: [
      "deepseek-ai/DeepSeek-V4-Pro",
      "moonshotai/Kimi-K2.5",
      "moonshotai/Kimi-K2.6",
    ...
    lilac: ["google/gemma-4-31b-it", "minimaxai/minimax-m3", "moonshotai/kimi-k2.6", "zai-org/glm-5.2"],
    ambient: ["moonshotai/kimi-k2.6", "moonshotai/kimi-k2.7-code", "zai-org/GLM-5.1-FP8"],
    neon: [
      "claude-haiku-4-5",
      "claude-opus-4-1",
      "claude-opus-4-5",
    ...
    "zhipuai-coding-plan": ["glm-4.5-air", "glm-4.6v", "glm-4.7", "glm-5-turbo", "glm-5.1", "glm-5.2", "glm-5v-turbo"],
    chutes: [
      "MiniMaxAI/MiniMax-M2.5-TEE",
      "Qwen/Qwen3-235B-A22B-Thinking-2507-TEE",
      "Qwen/Qwen3-32B-TEE",
...
function getPackageRoot() {
  try {
    const require2 = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-5FCWY4Z3.cjs', document.baseURI).href)) || "file://");
...
function loadRegistry(useDynamicLoading, customGateways = []) {
  const enabledGatewayIds = getEnabledGatewayIds([
    new chunkWFEGLWHX_cjs.ModelsDevGateway({}),
    new chunkVIRV756L_cjs.NetlifyGateway(),
    new MastraGateway(),
    ...customGateways
  ]);
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-2FIKRH25.cjs');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-RHVP5ZQM.cjs');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-XSKDVDEO.cjs');
      const { fetchProvidersFromGateways, writeRegistryFiles } = await import('./registry-generator-YPGBZQ5K.cjs');
...
var MastraGateway = class extends chunkA45A2T7R_cjs.MastraModelGateway {
  constructor(config) {
    super();
    this.config = config;
  }
  ...
  resolveLanguageModel({
    ...
    if (this.config?.customFetch && providerId === "anthropic") {
      return chunkA45A2T7R_cjs.createAnthropic({
        ...
        headers: {
          ...
          [chunkA45A2T7R_cjs.GATEWAY_AUTH_HEADER]: `Bearer ${apiKey}`,
          ...headers
        },
    ...
    if (this.config?.customFetch) {
      return chunkWFEGLWHX_cjs.createOpenRouter({
        apiKey: "oauth-gateway-placeholder",
        baseURL,
        headers: {
          "User-Agent": chunkA45A2T7R_cjs.MASTRA_USER_AGENT,
...
//# sourceMappingURL=chunk-5FCWY4Z3.cjs.map
//# sourceMappingURL=chunk-5FCWY4Z3.cjs.map