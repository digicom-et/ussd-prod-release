import type { LanguageModelV2, LanguageModelV2CallWarning, LanguageModelV2Prompt } from '../_types/@ai-sdk_provider-v5/dist/index.d.ts';
import type { CoreMessage as CoreMessageV4 } from '../_types/@internal_ai-sdk-v4/dist/index.d.ts';
import type { CallSettings, StepResult, ToolChoice } from '../_types/@internal_ai-sdk-v5/dist/index.d.ts';
import type { Agent } from '../agent/index.js';
import type { MessageList, MastraDBMessage } from '../agent/message-list/index.js';
import type { AgentSignalInput, AgentStateSignalInput, CreatedAgentSignal } from '../agent/signals.js';
import type { ApplyStateSignalResult } from '../agent/state-signals.js';
...
import type { DataChunkType, LanguageModelUsage, LLMStepResult, ProviderMetadata } from '../stream/types.js';
...
export interface ProcessorContext<TTripwireMetadata = unknown> extends Partial<ObservabilityContext> {
     ...
     */
    sendStateSignal?: (signal: AgentStateSignalInput | (Omit<AgentStateSignalInput, 'id'> & {
        id?: string;
 ...
 */
export interface ComputeStateSignalArgs<TTripwireMetadata = unknown> extends ProcessorMessageContext<TTripwireMetadata> {
    /** The current step number (0-indexed) */
    stepNumber: number;
...
export interface Processor<TId extends string = string, TTripwireMetadata = unknown> {
     ...
     * @experimental Agent state signals are experimental and may change in a future release.
     */
    computeStateSignal?(args: ComputeStateSignalArgs<TTripwireMetadata>): Promise<ComputeStateSignalResult> | ComputeStateSignalResult;
    /**
...
export type InputProcessor<TTripwireMetadata = unknown> = (WithRequired<Processor<string, TTripwireMetadata>, 'id' | 'processInput'> & Processor<string, TTripwireMetadata>) | (WithRequired<Processor<string, TTripwireMetadata>, 'id' | 'processInputStep'> & Processor<string, TTripwireMetadata>) | (WithRequired<Processor<string, TTripwireMetadata>, 'id' | 'computeStateSignal'> & Processor<string, TTripwireMetadata>) | (WithRequired<Processor<string, TTripwireMetadata>, 'id' | 'processLLMRequest'> & Processor<string, TTripwireMetadata>) | (WithRequired<Processor<string, TTripwireMetadata>, 'id' | 'processLLMResponse'> & Processor<string, TTripwireMetadata>);
...
export { isProcessorWorkflow } from './is-processor-workflow.js';
...
export { isBadRequestError, isRetryableOpenAIResponsesStreamError, StreamErrorRetryProcessor, type StreamErrorRetryDelayMs, type StreamErrorRetryMatcher, type StreamErrorRetryMatcherConfig, type StreamErrorRetryMatcherEntry, type StreamErrorRetryProcessorOptions, } from './stream-error-retry-processor.js';
export type { CompatRule } from './provider-history-compat.js';
export { ProcessorState, ProcessorRunner } from './runner.js';
export { createProcessorSendSignal } from './send-signal.js';
