...
import type { ChunkType, LanguageModelUsage, LLMStepResult, MastraModelOutputOptions, ProviderMetadata, StreamTransport, StepTripwireData, ToolCallChunk } from '../types.js';
/**
...
export declare class MastraModelOutput<OUTPUT = undefined> extends MastraBase {
     ...
     */
    get toolCalls(): Promise<ToolCallChunk[]>;
    /**
     ...
     */
    get warnings(): Promise<import("../../_types/@ai-sdk_provider-v5/dist/index.d.ts").LanguageModelV2CallWarning[]>;
    /**
     * Resolves to provider metadata generated during execution.
     */
    get providerMetadata(): Promise<ProviderMetadata | undefined>;
    /**
    ...
    get response(): Promise<{
        ...
        messages?: import("../../_types/@internal_ai-sdk-v5/dist/index.d.ts").StepResult<import("../../_types/@internal_ai-sdk-v5/dist/index.d.ts").ToolSet>["response"]["messages"];
        dbMessages?: MastraDBMessage[];
        uiMessages?: import("../../_types/@internal_ai-sdk-v5/dist/index.d.ts").UIMessage<[OUTPUT] extends [undefined] ? undefined : {
            structuredOutput?: OUTPUT | undefined;
        } & Record<string, unknown>, import("../../_types/@internal_ai-sdk-v5/dist/index.d.ts").UIDataTypes, import("../../_types/@internal_ai-sdk-v5/dist/index.d.ts").UITools>[] | undefined;
        id?: string;
        timestamp?: Date;
        modelId?: string;
    }>;
    ...
    /** @internal */
    _getImmediateToolCalls(): ToolCallChunk[];
    /** @internal */
    ...
    /** @internal */
    _getImmediateWarnings(): import("../../_types/@ai-sdk_provider-v5/dist/index.d.ts").LanguageModelV2CallWarning[];
    /** @internal */
    _getImmediateFinishReason(): string | undefined;
    /** @internal */
    _getImmediateProviderMetadata(): ProviderMetadata | undefined;
    /** @internal  */
    ...
    serializeState(): {
        ...
        toolCallStreamingMeta: Record<string, {
            toolName: string;
        ...
        warnings: import("../../_types/@ai-sdk_provider-v5/dist/index.d.ts").LanguageModelV2CallWarning[];
