...
import type { ReasoningLevel } from '../loop/types.js';
...
import type { AgentSkillsInput } from '../skills/types.js';
...
export type { ReasoningLevel } from '../loop/types.js';
 ...
 * @experimental Agent state signal APIs are experimental and may change in a future release.
 */
export type SendAgentStateSignalResult<OUTPUT = unknown> = (SendAgentSignalResult<OUTPUT> & {
    skipped?: false;
}) | {
    skipped: true;
    reason: 'unchanged';
