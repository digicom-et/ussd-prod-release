...
import type { DefinitionSource, TracingProperties, ObservabilityContext, TracingPolicy } from '../observability/index.js';
...
import type { CoreTool, ToolHooks, ToolPayloadTransformPolicy } from '../tools/types.js';
import type { DynamicArgument } from '../types/index.js';
import type { MastraVoice } from '../voice/index.js';
import type { OutputWriter, WorkflowRunStatus } from '../workflows/types.js';
import type { AnyWorkflow } from '../workflows/workflow.js';
import type { AnyWorkspace } from '../workspace/index.js';
import type { Skill, SkillMetadata } from '../workspace/skills/types.js';
import type { AgentExecutionOptions, AgentExecutionOptionsBase, MultiPrimitiveExecutionOptions, NetworkOptions, DelegationConfig } from './agent.types.js';
...
export declare class Agent<TAgentId extends string = string, TTools extends ToolsInput = ToolsInput, TOutput = undefined, TRequestContext extends Record<string, any> | unknown = unknown, TEditor extends AgentEditorConfig | undefined = AgentEditorConfig | undefined> extends MastraBase implements SubAgent<TAgentId, TRequestContext> {
     ...
     * ```
     */
    getSkill(skillName: string, options?: {
        requestContext?: RequestContext;
    }): Promise<Skill | null>;
    /**
     ...
     * fields.
     */
    getTracingPolicy(): TracingPolicy | undefined;
    /**
    ...
    private getSubAgentToolSchemas;
    /**
     ...
     * ```
     */
    listSuspendedRuns(options?: AgentListSuspendedRunsOptions): Promise<AgentListSuspendedRunsResult>;
    abortThreadStream(options: AgentSubscribeToThreadOptions): boolean;
    abortRunStream(runId: string): boolean;
    /**
     * @experimental Agent message APIs are experimental and may change in a future release.
     */
    sendMessage<OUTPUT = TOutput>(message: AgentMessageInput, target: SendAgentMessageOptions<OUTPUT>): SendAgentMessageResult<OUTPUT>;
    /**
     * @experimental Agent message APIs are experimental and may change in a future release.
     */
    queueMessage<OUTPUT = TOutput>(message: AgentMessageInput, target: QueueAgentMessageOptions<OUTPUT>): QueueAgentMessageResult<OUTPUT>;
    /**
     * @experimental Agent state signal APIs are experimental and may change in a future release.
     */
    sendStateSignal<OUTPUT = TOutput>(state: AgentStateSignalInput, target: SendAgentStateSignalOptions<OUTPUT>): Promise<SendAgentStateSignalResult<OUTPUT>>;
    /**
     * @experimental Agent notification signal APIs are experimental and may change in a future release.
     */
    sendNotificationSignal<OUTPUT = TOutput>(notification: SendNotificationSignalInput, target: SendAgentNotificationSignalOptions<OUTPUT>): Promise<SendAgentNotificationSignalResult<OUTPUT>>;
    sendNotificationSignal<OUTPUT = TOutput>(notification: SendNotificationSignalInput[], target: SendAgentNotificationSignalOptions<OUTPUT>): Promise<SendAgentNotificationSignalResult<OUTPUT>[]>;
    /**
     * @experimental Agent signals are experimental and may change in a future release.
     */
    sendSignal<OUTPUT = TOutput>(signal: AgentSignal, target: SendAgentSignalOptions<OUTPUT>): SendAgentSignalResult<OUTPUT>;
    ...
    sendStreamResume<OUTPUT = undefined>(options: SendAgentStreamResumeOptions<OUTPUT>): Promise<SendAgentStreamResumeResult>;
