...
import type * as AIV4Type from '../../_types/@internal_ai-sdk-v4/dist/index.d.ts';
...
export declare class MessageList {
    ...
    add(messages: MessageListInput, messageSource: MessageSource, options?: MessageListAddOptions): this;
    ...
    updateMessageMetadataByToolCallId(toolCallId: string, metadata: Record<string, unknown>): boolean;
    /**
