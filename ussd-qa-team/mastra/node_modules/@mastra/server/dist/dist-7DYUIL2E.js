import { Memory } from './chunk-WWPJKPP2.js';
import { openai } from './chunk-2WRJFEJK.js';
import { standardSchemaToJSONSchema } from './chunk-JIL453ER.js';
...
var createModelInstance = async (provider, modelId, version = "v2") => {
  try {
    const providerMap = {
      v1: {
        openai: async () => {
          const { openai: openai2 } = await import('./dist-CB67HEFG.js');
          return openai2(modelId);
        },
        anthropic: async () => {
          const { anthropic } = await import('./dist-J4UWKVDM.js');
          return anthropic(modelId);
        },
        groq: async () => {
          const { groq } = await import('./dist-2YFKAQMY.js');
          return groq(modelId);
        },
        xai: async () => {
          const { xai } = await import('./dist-JWLVQJFQ.js');
          return xai(modelId);
        },
        google: async () => {
          const { google } = await import('./dist-IPZQFQMB.js');
...
//# sourceMappingURL=dist-7DYUIL2E.js.map
//# sourceMappingURL=dist-7DYUIL2E.js.map