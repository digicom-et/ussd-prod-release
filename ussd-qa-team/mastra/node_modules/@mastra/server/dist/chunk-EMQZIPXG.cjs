...
var LIST_STORED_PROMPT_BLOCKS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/prompt-blocks",
  responseType: "json",
  queryParamSchema: chunkIABGFWY2_cjs.listStoredPromptBlocksQuerySchema,
  responseSchema: chunkIABGFWY2_cjs.listStoredPromptBlocksResponseSchema,
  ...
  handler: async ({ mastra, page, perPage, orderBy, status, authorId, metadata, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing stored prompt blocks");
    }
  }
});
var GET_STORED_PROMPT_BLOCK_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/prompt-blocks/:storedPromptBlockId",
  responseType: "json",
  pathParamSchema: chunkIABGFWY2_cjs.storedPromptBlockIdPathParams,
  queryParamSchema: chunkDIG2K5CV_cjs.statusQuerySchema,
  responseSchema: chunkIABGFWY2_cjs.getStoredPromptBlockResponseSchema,
  ...
  handler: async ({ mastra, storedPromptBlockId, status, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting stored prompt block");
    }
  }
});
var CREATE_STORED_PROMPT_BLOCK_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/prompt-blocks",
  responseType: "json",
  bodySchema: chunkIABGFWY2_cjs.createStoredPromptBlockBodySchema,
  responseSchema: chunkIABGFWY2_cjs.createStoredPromptBlockResponseSchema,
  ...
  handler: async ({
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error creating stored prompt block");
    }
  }
});
var UPDATE_STORED_PROMPT_BLOCK_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "PATCH",
  path: "/stored/prompt-blocks/:storedPromptBlockId",
  responseType: "json",
  pathParamSchema: chunkIABGFWY2_cjs.storedPromptBlockIdPathParams,
  bodySchema: chunkIABGFWY2_cjs.updateStoredPromptBlockBodySchema,
  responseSchema: chunkIABGFWY2_cjs.updateStoredPromptBlockResponseSchema,
  ...
  handler: async ({
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error updating stored prompt block");
    }
  }
});
var DELETE_STORED_PROMPT_BLOCK_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "DELETE",
  path: "/stored/prompt-blocks/:storedPromptBlockId",
  responseType: "json",
  pathParamSchema: chunkIABGFWY2_cjs.storedPromptBlockIdPathParams,
  responseSchema: chunkIABGFWY2_cjs.deleteStoredPromptBlockResponseSchema,
  ...
  handler: async ({ mastra, storedPromptBlockId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error deleting stored prompt block");
    }
  }
});
...
//# sourceMappingURL=chunk-EMQZIPXG.cjs.map
//# sourceMappingURL=chunk-EMQZIPXG.cjs.map