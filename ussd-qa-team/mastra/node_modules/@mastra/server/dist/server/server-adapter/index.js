import { getEffectivePermission, SERVER_ROUTES } from '../../chunk-V4X6NCFW.js';
export { SERVER_ROUTES, deriveAction, derivePermission, extractResource, getEffectivePermission } from '../../chunk-V4X6NCFW.js';
import { coreAuthMiddleware } from '../../chunk-HATXNJ4V.js';
import { normalizeRoutePath } from '../../chunk-EOGTJIPF.js';
export { WorkflowRegistry, normalizeRoutePath } from '../../chunk-EOGTJIPF.js';
import { isReservedRequestContextKey, isStudioClientTypeHeader, MASTRA_CLIENT_TYPE_HEADER, MASTRA_IS_STUDIO_KEY, MASTRA_AUTH_MODE_KEY, MASTRA_RESOURCE_ID_KEY } from '../../chunk-5FOSK5R3.js';
export { MASTRA_AUTH_MODE_KEY, MASTRA_CLIENT_TYPE_HEADER, MASTRA_IS_STUDIO_KEY, MASTRA_STUDIO_CLIENT_TYPE, isReservedRequestContextKey, isStudioClientTypeHeader } from '../../chunk-5FOSK5R3.js';
import { formatZodError } from '../../chunk-7ZWJX3AN.js';
export { isZodError } from '../../chunk-7ZWJX3AN.js';
import { generateOpenAPIDocument, convertCustomRoutesToOpenAPIPaths } from '../../chunk-Z5MTOVTR.js';
export { createPublicRoute, createRoute, generateOpenAPIDocument, jsonQueryParam, pickParams, wrapSchemaForQueryParams } from '../../chunk-Z5MTOVTR.js';
...
var MastraServer = class _MastraServer extends MastraServerBase {
  mastra;
  bodyLimitOptions;
  tools;
  prefix;
...
Ensure @mastra/core is updated to a version that includes EE support.`
  ...
  async validateFGAPolicyCoverage() {
    ...
    const routes = [...SERVER_ROUTES, ...customRoutes];
  ...
  resolveValidationError(route, error, context) {
    ...
    return {
      status: 400,
      body: formatZodError(error, _MastraServer.CONTEXT_LABELS[context])
    };
  }
};
...
export { MastraServer, checkRouteFGA, normalizeQueryParams, redactStreamChunk, serializeStreamChunk };
