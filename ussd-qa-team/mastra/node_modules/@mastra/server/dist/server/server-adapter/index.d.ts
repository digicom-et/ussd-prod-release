...
export declare abstract class MastraServer<TApp, TRequest, TResponse> extends MastraServerBase<TApp> {
     ...
     */
    protected handleCustomRouteRequest(url: string, method: string, headers: Record<string, string | string[] | undefined>, body: unknown, requestContext?: RequestContext, signal?: AbortSignal): Promise<Response | null>;
    /**
