export declare const LIST_SCORERS_ROUTE: import("../server-adapter").ServerRoute<{}, Record<string, {
    scorer: {
        config: {
            id: string;
            description: string;
...
}, import("zod/v4/core").$strip>>, "GET", "/scores/run/:runId">;
export declare const LIST_SCORES_BY_SCORER_ID_ROUTE: import("../server-adapter").ServerRoute<import("../server-adapter").InferParams<import("zod").ZodObject<{
    ...
    scores: import("zod").ZodArray<import("zod").ZodUnknown>;
}, import("zod/v4/core").$strip>>, "GET", "/scores/scorer/:scorerId">;
export declare const LIST_SCORES_BY_ENTITY_ID_ROUTE: import("../server-adapter").ServerRoute<import("../server-adapter").InferParams<import("zod").ZodObject<{
    ...
    scores: import("zod").ZodArray<import("zod").ZodUnknown>;
}, import("zod/v4/core").$strip>>, "GET", "/scores/entity/:entityType/:entityId">;
