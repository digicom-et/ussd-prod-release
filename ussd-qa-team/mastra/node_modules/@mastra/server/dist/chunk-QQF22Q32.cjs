...
var filterSchema = v4.z.preprocess(
  ...
  v4.z.object({
    dateRange: v4.z.object({
      ...
      startExclusive: v4.z.boolean().optional(),
      endExclusive: v4.z.boolean().optional()
    }).optional(),
    roles: v4.z.array(v4.z.string()).optional()
  })
).optional();
var memoryConfigSchema = v4.z.preprocess(
  (val) => {
    if (val === void 0) return val;
    if (typeof val === "string") {
      try {
  ...
  v4.z.record(v4.z.string(), v4.z.unknown())
).optional();
...
var listThreadsQueryInnerSchema = chunkDIG2K5CV_cjs.createPagePaginationSchema(100).extend({
  agentId: v4.z.string().optional(),
  resourceId: v4.z.string().optional(),
...
var listThreadsQuerySchema = v4.z.preprocess((val) => {
  ...
  const direction = typeof record.sortDirection === "string" ? record.sortDirection : void 0;
...
var listMessagesQuerySchema = chunkDIG2K5CV_cjs.createPagePaginationSchema(40).extend({
  agentId: v4.z.string().optional(),
  resourceId: v4.z.string().optional(),
  orderBy: messageOrderBySchema,
  include: includeSchema,
  filter: filterSchema,
  includeSystemReminders: v4.z.preprocess((val) => {
    if (val === void 0) return val;
...
var listThreadsNetworkQuerySchema = chunkDIG2K5CV_cjs.createPagePaginationSchema(100).extend({
  agentId: v4.z.string().optional(),
  resourceId: v4.z.string().optional(),
  metadata: v4.z.preprocess(
    (val) => {
...
var listMessagesNetworkQuerySchema = chunkDIG2K5CV_cjs.createPagePaginationSchema(40).extend({
  agentId: v4.z.string().optional(),
  resourceId: v4.z.string().optional(),
  orderBy: messageOrderBySchema,
  include: includeSchema,
...
var memoryStatusResponseSchema = v4.z.object({
  result: v4.z.boolean(),
  memoryType: v4.z.enum(["local", "gateway"]).optional(),
...
var observationalMemoryModelRoutingSchema = v4.z.array(
  v4.z.object({
    upTo: v4.z.number(),
    model: v4.z.string()
  })
...
var listThreadsResponseSchema = chunkDIG2K5CV_cjs.paginationInfoSchema.extend({
...
var updateWorkingMemoryResponseSchema = chunkDIG2K5CV_cjs.successResponseSchema;
var deleteMessagesResponseSchema = chunkDIG2K5CV_cjs.successResponseSchema.extend({
  message: v4.z.string()
});
...
var getObservationalMemoryQuerySchema = v4.z.object({
  ...
  resourceId: v4.z.string().optional(),
  threadId: v4.z.string().optional(),
  from: v4.z.coerce.date().optional(),
  to: v4.z.coerce.date().optional(),
  offset: v4.z.coerce.number().int().min(0).optional(),
  limit: v4.z.coerce.number().int().min(1).optional()
});
var bufferedObservationChunkSchema = v4.z.object({
  id: v4.z.string().optional(),
  cycleId: v4.z.string(),
  observations: v4.z.string(),
  tokenCount: v4.z.number(),
  messageIds: v4.z.array(v4.z.string()).optional(),
  messageTokens: v4.z.number(),
  lastObservedAt: v4.z.date().optional(),
  createdAt: v4.z.date().optional(),
  suggestedContinuation: v4.z.string().optional(),
  currentTask: v4.z.string().optional(),
  threadTitle: v4.z.string().optional(),
  extractedValues: v4.z.record(v4.z.string(), v4.z.unknown()).optional(),
  extractionFailures: v4.z.array(v4.z.object({ slug: v4.z.string(), error: v4.z.string() })).optional()
});
var observationalMemoryRecordSchema = v4.z.object({
  ...
  bufferedObservationChunks: v4.z.array(bufferedObservationChunkSchema).optional(),
...
//# sourceMappingURL=chunk-QQF22Q32.cjs.map
//# sourceMappingURL=chunk-QQF22Q32.cjs.map