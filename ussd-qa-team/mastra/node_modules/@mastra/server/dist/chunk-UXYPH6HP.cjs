...
chunkO7I5CWRX_cjs.__export(mcp_exports, {
  ...
  LIST_MCP_SERVER_RESOURCES_ROUTE: () => LIST_MCP_SERVER_RESOURCES_ROUTE,
  ...
  READ_MCP_SERVER_RESOURCE_ROUTE: () => READ_MCP_SERVER_RESOURCE_ROUTE
});
var LIST_MCP_SERVERS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/mcp/v0/servers",
  responseType: "json",
  queryParamSchema: chunkBNR5CIPX_cjs.listMcpServersQuerySchema,
  responseSchema: chunkBNR5CIPX_cjs.listMcpServersResponseSchema,
...
var GET_MCP_SERVER_DETAIL_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/mcp/v0/servers/:id",
  responseType: "json",
  pathParamSchema: chunkBNR5CIPX_cjs.mcpServerDetailPathParams,
  queryParamSchema: chunkBNR5CIPX_cjs.getMcpServerDetailQuerySchema,
  responseSchema: chunkBNR5CIPX_cjs.serverDetailSchema,
...
var LIST_MCP_SERVER_TOOLS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/mcp/:serverId/tools",
  responseType: "json",
  pathParamSchema: chunkBNR5CIPX_cjs.mcpServerIdPathParams,
  responseSchema: chunkBNR5CIPX_cjs.listMcpServerToolsResponseSchema,
...
var GET_MCP_SERVER_TOOL_DETAIL_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/mcp/:serverId/tools/:toolId",
  responseType: "json",
  pathParamSchema: chunkBNR5CIPX_cjs.mcpServerToolPathParams,
  responseSchema: chunkBNR5CIPX_cjs.mcpToolInfoSchema,
...
var EXECUTE_MCP_SERVER_TOOL_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/mcp/:serverId/tools/:toolId/execute",
  responseType: "json",
  pathParamSchema: chunkBNR5CIPX_cjs.mcpServerToolPathParams,
  bodySchema: chunkBNR5CIPX_cjs.executeToolBodySchema,
  responseSchema: chunkBNR5CIPX_cjs.executeToolResponseSchema,
...
var LIST_MCP_SERVER_RESOURCES_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/mcp/:serverId/resources",
  responseType: "json",
  pathParamSchema: chunkBNR5CIPX_cjs.mcpServerResourcePathParams,
  responseSchema: chunkBNR5CIPX_cjs.listResourcesResponseSchema,
...
var READ_MCP_SERVER_RESOURCE_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/mcp/:serverId/resources/read",
  responseType: "json",
  pathParamSchema: chunkBNR5CIPX_cjs.mcpServerResourcePathParams,
  bodySchema: chunkBNR5CIPX_cjs.readResourceBodySchema,
  responseSchema: chunkBNR5CIPX_cjs.readResourceResponseSchema,
  ...
  handler: async ({ mastra, serverId, uri }) => {
    ...
    if (typeof server.readResource !== "function") {
      throw new chunk64ITUOXI_cjs.HTTPException(501, { message: `Server '${serverId}' does not support reading resources` });
    }
    try {
      ...
      if (message.includes("not found") || message.includes("not configured")) {
        throw new chunk64ITUOXI_cjs.HTTPException(404, { message: `Resource '${uri}' not found on server '${serverId}'` });
      }
      throw error;
    }
  }
});
var MCP_HTTP_TRANSPORT_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "ALL",
...
var MCP_SSE_TRANSPORT_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "ALL",
...
var MCP_SSE_MESSAGES_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
...
exports.LIST_MCP_SERVER_RESOURCES_ROUTE = LIST_MCP_SERVER_RESOURCES_ROUTE;
...
exports.READ_MCP_SERVER_RESOURCE_ROUTE = READ_MCP_SERVER_RESOURCE_ROUTE;
exports.mcp_exports = mcp_exports;
//# sourceMappingURL=chunk-UXYPH6HP.cjs.map
//# sourceMappingURL=chunk-UXYPH6HP.cjs.map