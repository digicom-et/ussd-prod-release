...
var LIST_SCORER_VERSIONS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/scorers/:scorerId/versions",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkOWWI7PFV_cjs.scorerVersionPathParams,
  queryParamSchema: chunkOWWI7PFV_cjs.listScorerVersionsQuerySchema,
  responseSchema: chunkOWWI7PFV_cjs.listScorerVersionsResponseSchema,
  ...
  handler: async ({ mastra, scorerId, page, perPage, orderBy, requestContext }) => {
    try {
      ...
      chunkYWUVDFQZ_cjs.assertStoredResourceScope(scorer, await chunkYWUVDFQZ_cjs.getStoredResourceScope(mastra, requestContext));
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing scorer versions");
    }
  }
});
var CREATE_SCORER_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/scorers/:scorerId/versions",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkOWWI7PFV_cjs.scorerVersionPathParams,
  bodySchema: chunkOWWI7PFV_cjs.createScorerVersionBodySchema,
  responseSchema: chunkOWWI7PFV_cjs.createScorerVersionResponseSchema,
  ...
  handler: async ({ mastra, scorerId, changeMessage, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error creating scorer version");
    }
  }
});
var GET_SCORER_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/scorers/:scorerId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkOWWI7PFV_cjs.scorerVersionIdPathParams,
  responseSchema: chunkOWWI7PFV_cjs.getScorerVersionResponseSchema,
  ...
  handler: async ({ mastra, scorerId, versionId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting scorer version");
    }
  }
});
var ACTIVATE_SCORER_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/scorers/:scorerId/versions/:versionId/activate",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkOWWI7PFV_cjs.scorerVersionIdPathParams,
  responseSchema: chunkOWWI7PFV_cjs.activateScorerVersionResponseSchema,
  ...
  handler: async ({ mastra, scorerId, versionId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error activating scorer version");
    }
  }
});
var RESTORE_SCORER_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/scorers/:scorerId/versions/:versionId/restore",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkOWWI7PFV_cjs.scorerVersionIdPathParams,
  responseSchema: chunkOWWI7PFV_cjs.restoreScorerVersionResponseSchema,
  ...
  handler: async ({ mastra, scorerId, versionId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error restoring scorer version");
    }
  }
});
var DELETE_SCORER_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "DELETE",
  path: "/stored/scorers/:scorerId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkOWWI7PFV_cjs.scorerVersionIdPathParams,
  responseSchema: chunkOWWI7PFV_cjs.deleteScorerVersionResponseSchema,
  ...
  handler: async ({ mastra, scorerId, versionId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error deleting scorer version");
    }
  }
});
var COMPARE_SCORER_VERSIONS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/scorers/:scorerId/versions/compare",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkOWWI7PFV_cjs.scorerVersionPathParams,
  queryParamSchema: chunkOWWI7PFV_cjs.compareScorerVersionsQuerySchema,
  responseSchema: chunkOWWI7PFV_cjs.compareScorerVersionsResponseSchema,
  ...
  handler: async ({ mastra, scorerId, from, to, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error comparing scorer versions");
    }
  }
});
...
//# sourceMappingURL=chunk-ZGAUP346.cjs.map
//# sourceMappingURL=chunk-ZGAUP346.cjs.map