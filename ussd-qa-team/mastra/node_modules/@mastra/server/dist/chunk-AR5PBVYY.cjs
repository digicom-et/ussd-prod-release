...
var LIST_AGENT_VERSIONS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/agents/:agentId/versions",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkWNK6NJYP_cjs.agentVersionPathParams,
  queryParamSchema: chunkGFP7IMFR_cjs.listVersionsQuerySchema,
  responseSchema: chunkWNK6NJYP_cjs.listVersionsResponseSchema,
  ...
  handler: async ({ mastra, agentId, page, perPage, orderBy, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing agent versions");
    }
  }
});
var CREATE_AGENT_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/agents/:agentId/versions",
  requiresAuth: true,
  responseType: "json",
  ...
  responseSchema: chunkWNK6NJYP_cjs.createVersionResponseSchema,
  ...
  handler: async ({ mastra, agentId, changeMessage, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error creating agent version");
    }
  }
});
var GET_AGENT_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/agents/:agentId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkWNK6NJYP_cjs.versionIdPathParams,
  responseSchema: chunkWNK6NJYP_cjs.getVersionResponseSchema,
  ...
  handler: async ({ mastra, agentId, versionId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting agent version");
    }
  }
});
var ACTIVATE_AGENT_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  ...
  handler: async ({ mastra, agentId, versionId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error activating agent version");
    }
  }
});
var RESTORE_AGENT_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/agents/:agentId/versions/:versionId/restore",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkWNK6NJYP_cjs.versionIdPathParams,
  responseSchema: chunkWNK6NJYP_cjs.restoreVersionResponseSchema,
  ...
  handler: async ({ mastra, agentId, versionId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error restoring agent version");
    }
  }
});
var DELETE_AGENT_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "DELETE",
  path: "/stored/agents/:agentId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
  ...
  handler: async ({ mastra, agentId, versionId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error deleting agent version");
    }
  }
});
var COMPARE_AGENT_VERSIONS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  ...
  responseSchema: chunkWNK6NJYP_cjs.compareVersionsResponseSchema,
  ...
  handler: async ({ mastra, agentId, from, to, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error comparing agent versions");
    }
  }
});
...
//# sourceMappingURL=chunk-AR5PBVYY.cjs.map
//# sourceMappingURL=chunk-AR5PBVYY.cjs.map