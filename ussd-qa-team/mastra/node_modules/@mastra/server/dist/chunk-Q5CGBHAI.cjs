...
var LIST_PROMPT_BLOCK_VERSIONS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/prompt-blocks/:promptBlockId/versions",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkTXM2XTUT_cjs.promptBlockVersionPathParams,
  queryParamSchema: chunkTXM2XTUT_cjs.listPromptBlockVersionsQuerySchema,
  responseSchema: chunkTXM2XTUT_cjs.listPromptBlockVersionsResponseSchema,
  ...
  handler: async ({ mastra, promptBlockId, page, perPage, orderBy, requestContext }) => {
    try {
      ...
      chunkYWUVDFQZ_cjs.assertStoredResourceScope(promptBlock, await chunkYWUVDFQZ_cjs.getStoredResourceScope(mastra, requestContext));
...
var CREATE_PROMPT_BLOCK_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/prompt-blocks/:promptBlockId/versions",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkTXM2XTUT_cjs.promptBlockVersionPathParams,
  bodySchema: chunkTXM2XTUT_cjs.createPromptBlockVersionBodySchema,
  responseSchema: chunkTXM2XTUT_cjs.createPromptBlockVersionResponseSchema,
...
var GET_PROMPT_BLOCK_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/prompt-blocks/:promptBlockId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkTXM2XTUT_cjs.promptBlockVersionIdPathParams,
  responseSchema: chunkTXM2XTUT_cjs.getPromptBlockVersionResponseSchema,
...
var ACTIVATE_PROMPT_BLOCK_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/prompt-blocks/:promptBlockId/versions/:versionId/activate",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkTXM2XTUT_cjs.promptBlockVersionIdPathParams,
  responseSchema: chunkTXM2XTUT_cjs.activatePromptBlockVersionResponseSchema,
...
var RESTORE_PROMPT_BLOCK_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/prompt-blocks/:promptBlockId/versions/:versionId/restore",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkTXM2XTUT_cjs.promptBlockVersionIdPathParams,
  responseSchema: chunkTXM2XTUT_cjs.restorePromptBlockVersionResponseSchema,
...
var DELETE_PROMPT_BLOCK_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "DELETE",
  path: "/stored/prompt-blocks/:promptBlockId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkTXM2XTUT_cjs.promptBlockVersionIdPathParams,
  responseSchema: chunkTXM2XTUT_cjs.deletePromptBlockVersionResponseSchema,
...
var COMPARE_PROMPT_BLOCK_VERSIONS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/prompt-blocks/:promptBlockId/versions/compare",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkTXM2XTUT_cjs.promptBlockVersionPathParams,
  queryParamSchema: chunkTXM2XTUT_cjs.comparePromptBlockVersionsQuerySchema,
  responseSchema: chunkTXM2XTUT_cjs.comparePromptBlockVersionsResponseSchema,
...
//# sourceMappingURL=chunk-Q5CGBHAI.cjs.map
//# sourceMappingURL=chunk-Q5CGBHAI.cjs.map