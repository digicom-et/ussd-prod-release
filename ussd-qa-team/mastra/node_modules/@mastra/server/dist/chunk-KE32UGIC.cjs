...
var LIST_STORED_SCORERS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/scorers",
  responseType: "json",
  queryParamSchema: chunkTD4U2UEE_cjs.listStoredScorersQuerySchema,
  responseSchema: chunkTD4U2UEE_cjs.listStoredScorersResponseSchema,
  ...
  handler: async ({ mastra, page, perPage, orderBy, status, authorId, metadata, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing stored scorer definitions");
    }
  }
});
var GET_STORED_SCORER_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/scorers/:storedScorerId",
  responseType: "json",
  pathParamSchema: chunkTD4U2UEE_cjs.storedScorerIdPathParams,
  queryParamSchema: chunkDIG2K5CV_cjs.statusQuerySchema,
  responseSchema: chunkTD4U2UEE_cjs.getStoredScorerResponseSchema,
  ...
  handler: async ({ mastra, storedScorerId, status, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting stored scorer definition");
    }
  }
});
var CREATE_STORED_SCORER_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/scorers",
  responseType: "json",
  bodySchema: chunkTD4U2UEE_cjs.createStoredScorerBodySchema,
  responseSchema: chunkTD4U2UEE_cjs.createStoredScorerResponseSchema,
  ...
  handler: async ({
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error creating stored scorer definition");
    }
  }
});
var UPDATE_STORED_SCORER_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "PATCH",
  path: "/stored/scorers/:storedScorerId",
  responseType: "json",
  pathParamSchema: chunkTD4U2UEE_cjs.storedScorerIdPathParams,
  bodySchema: chunkTD4U2UEE_cjs.updateStoredScorerBodySchema,
  responseSchema: chunkTD4U2UEE_cjs.updateStoredScorerResponseSchema,
  ...
  handler: async ({
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error updating stored scorer definition");
    }
  }
});
var DELETE_STORED_SCORER_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "DELETE",
  path: "/stored/scorers/:storedScorerId",
  responseType: "json",
  pathParamSchema: chunkTD4U2UEE_cjs.storedScorerIdPathParams,
  responseSchema: chunkTD4U2UEE_cjs.deleteStoredScorerResponseSchema,
  ...
  handler: async ({ mastra, storedScorerId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error deleting stored scorer definition");
    }
  }
});
...
//# sourceMappingURL=chunk-KE32UGIC.cjs.map
//# sourceMappingURL=chunk-KE32UGIC.cjs.map