...
var LIST_MCP_CLIENT_VERSIONS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/mcp-clients/:mcpClientId/versions",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkSGXBKIPB_cjs.mcpClientVersionPathParams,
  queryParamSchema: chunkSGXBKIPB_cjs.listMCPClientVersionsQuerySchema,
  responseSchema: chunkSGXBKIPB_cjs.listMCPClientVersionsResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, page, perPage, orderBy, requestContext }) => {
    try {
      ...
      chunkYWUVDFQZ_cjs.assertStoredResourceScope(mcpClient, await chunkYWUVDFQZ_cjs.getStoredResourceScope(mastra, requestContext));
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing MCP client versions");
    }
  }
});
var CREATE_MCP_CLIENT_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/mcp-clients/:mcpClientId/versions",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkSGXBKIPB_cjs.mcpClientVersionPathParams,
  bodySchema: chunkSGXBKIPB_cjs.createMCPClientVersionBodySchema,
  responseSchema: chunkSGXBKIPB_cjs.createMCPClientVersionResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, changeMessage, requestContext }) => {
    try {
      ...
      if (mcpClient.activeVersionId) {
        ...
        if (activeVersion) {
          currentConfig = chunk2XZ2466F_cjs.extractConfigFromVersion(
            activeVersion,
            chunk2XZ2466F_cjs.MCP_CLIENT_SNAPSHOT_CONFIG_FIELDS
          );
        }
      }
      ...
      const previousConfig = latestVersion ? chunk2XZ2466F_cjs.extractConfigFromVersion(
        latestVersion,
        chunk2XZ2466F_cjs.MCP_CLIENT_SNAPSHOT_CONFIG_FIELDS
      ) : null;
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error creating MCP client version");
    }
  }
});
var GET_MCP_CLIENT_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/mcp-clients/:mcpClientId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkSGXBKIPB_cjs.mcpClientVersionIdPathParams,
  responseSchema: chunkSGXBKIPB_cjs.getMCPClientVersionResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, versionId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting MCP client version");
    }
  }
});
var ACTIVATE_MCP_CLIENT_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/mcp-clients/:mcpClientId/versions/:versionId/activate",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkSGXBKIPB_cjs.mcpClientVersionIdPathParams,
  responseSchema: chunkSGXBKIPB_cjs.activateMCPClientVersionResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, versionId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error activating MCP client version");
    }
  }
});
var RESTORE_MCP_CLIENT_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/mcp-clients/:mcpClientId/versions/:versionId/restore",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkSGXBKIPB_cjs.mcpClientVersionIdPathParams,
  responseSchema: chunkSGXBKIPB_cjs.restoreMCPClientVersionResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, versionId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error restoring MCP client version");
    }
  }
});
var DELETE_MCP_CLIENT_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "DELETE",
  path: "/stored/mcp-clients/:mcpClientId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkSGXBKIPB_cjs.mcpClientVersionIdPathParams,
  responseSchema: chunkSGXBKIPB_cjs.deleteMCPClientVersionResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, versionId, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error deleting MCP client version");
    }
  }
});
var COMPARE_MCP_CLIENT_VERSIONS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/mcp-clients/:mcpClientId/versions/compare",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkSGXBKIPB_cjs.mcpClientVersionPathParams,
  queryParamSchema: chunkSGXBKIPB_cjs.compareMCPClientVersionsQuerySchema,
  responseSchema: chunkSGXBKIPB_cjs.compareMCPClientVersionsResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, from, to, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error comparing MCP client versions");
    }
  }
});

exports.ACTIVATE_MCP_CLIENT_VERSION_ROUTE = ACTIVATE_MCP_CLIENT_VERSION_ROUTE;
exports.COMPARE_MCP_CLIENT_VERSIONS_ROUTE = COMPARE_MCP_CLIENT_VERSIONS_ROUTE;
exports.CREATE_MCP_CLIENT_VERSION_ROUTE = CREATE_MCP_CLIENT_VERSION_ROUTE;
exports.DELETE_MCP_CLIENT_VERSION_ROUTE = DELETE_MCP_CLIENT_VERSION_ROUTE;
...
//# sourceMappingURL=chunk-FOANUZQ3.cjs.map
//# sourceMappingURL=chunk-FOANUZQ3.cjs.map