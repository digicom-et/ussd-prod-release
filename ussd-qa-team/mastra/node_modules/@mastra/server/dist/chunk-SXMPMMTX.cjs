...
var LIST_CHANNEL_PLATFORMS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  ...
  handler: async ({ mastra }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing channel platforms");
    }
  }
});
var LIST_CHANNEL_INSTALLATIONS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ mastra, platform }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing channel installations");
    }
  }
});
var CONNECT_CHANNEL_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  ...
  handler: async ({ mastra, requestContext, platform, agentId, options }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error connecting agent to channel");
    }
  }
});
var DISCONNECT_CHANNEL_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  ...
  handler: async ({ mastra, requestContext, platform, agentId }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error disconnecting agent from channel");
    }
  }
});
