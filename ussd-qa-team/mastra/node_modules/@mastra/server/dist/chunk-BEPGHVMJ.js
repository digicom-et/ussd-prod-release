import { capabilitiesResponseSchema, currentUserResponseSchema, ssoLoginQuerySchema, ssoCallbackQuerySchema, refreshResponseSchema, credentialsSignInBodySchema, credentialsSignUpBodySchema, permissionPatternsResponseSchema } from './chunk-LWA65ME7.js';
import { supportsSessionRefresh } from './chunk-HATXNJ4V.js';
import { MASTRA_USER_PERMISSIONS_KEY, isStudioClientTypeHeader, MASTRA_CLIENT_TYPE_HEADER } from './chunk-5FOSK5R3.js';
import { handleError } from './chunk-7ZWJX3AN.js';
import { createPublicRoute, createRoute } from './chunk-Z5MTOVTR.js';
...
function isStudioRequest(request) {
  return isStudioClientTypeHeader(request.headers.get(MASTRA_CLIENT_TYPE_HEADER) ?? void 0);
}
...
var POST_REFRESH_ROUTE = createPublicRoute({
  method: "POST",
  path: "/auth/refresh",
  responseType: "datastream-response",
...
var GET_ROLE_PERMISSIONS_ROUTE = createRoute({
  method: "GET",
...
var GET_PERMISSION_PATTERNS_ROUTE = createRoute({
  method: "GET",
...
export { AUTH_ROUTES, GET_AUTH_CAPABILITIES_ROUTE, GET_CURRENT_USER_ROUTE, GET_PERMISSION_PATTERNS_ROUTE, GET_ROLE_PERMISSIONS_ROUTE, GET_SSO_CALLBACK_ROUTE, GET_SSO_LOGIN_ROUTE, POST_CREDENTIALS_SIGN_IN_ROUTE, POST_CREDENTIALS_SIGN_UP_ROUTE, POST_LOGOUT_ROUTE, POST_REFRESH_ROUTE, getPublicOrigin };
//# sourceMappingURL=chunk-BEPGHVMJ.js.map
//# sourceMappingURL=chunk-BEPGHVMJ.js.map