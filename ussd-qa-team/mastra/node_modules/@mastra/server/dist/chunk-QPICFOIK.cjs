...
async function upsertVectors({
  ...
  try {
    ...
    return chunkZ7LCIYK7_cjs.handleError(error, "Error upserting vectors");
  }
}
async function createIndex({
  ...
  try {
    ...
    return chunkZ7LCIYK7_cjs.handleError(error, "Error creating index");
  }
}
async function queryVectors({
  ...
  try {
    ...
    return chunkZ7LCIYK7_cjs.handleError(error, "Error querying vectors");
  }
}
async function listIndexes({ mastra, vectorName }) {
  try {
    ...
    return chunkZ7LCIYK7_cjs.handleError(error, "Error listing indexes");
  }
}
async function describeIndex({
  ...
  try {
    ...
    return chunkZ7LCIYK7_cjs.handleError(error, "Error describing index");
  }
}
async function deleteIndex({
  ...
  try {
    ...
    return chunkZ7LCIYK7_cjs.handleError(error, "Error deleting index");
  }
}
async function listVectorStores({ mastra }) {
  try {
    ...
    const vectorList = Object.entries(vectors).map(([name, vector]) => ({
      name,
      id: vector.id || name,
      // Use the key as fallback when vector has no id property
      type: vector.constructor.name
      // Add any other metadata that might be useful
    }));
    return { vectors: vectorList };
  } catch (error) {
    return chunkZ7LCIYK7_cjs.handleError(error, "Error listing vector stores");
  }
}
var UPSERT_VECTORS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/vector/:vectorName/upsert",
  responseType: "json",
  pathParamSchema: chunkLZ32IIH2_cjs.vectorNamePathParams,
  bodySchema: chunkLZ32IIH2_cjs.upsertVectorsBodySchema,
...
var CREATE_INDEX_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/vector/:vectorName/create-index",
  responseType: "json",
  pathParamSchema: chunkLZ32IIH2_cjs.vectorNamePathParams,
  bodySchema: chunkLZ32IIH2_cjs.createIndexBodySchema,
  responseSchema: chunkLZ32IIH2_cjs.createIndexResponseSchema,
...
var QUERY_VECTORS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/vector/:vectorName/query",
  responseType: "json",
  pathParamSchema: chunkLZ32IIH2_cjs.vectorNamePathParams,
  bodySchema: chunkLZ32IIH2_cjs.queryVectorsBodySchema,
  responseSchema: chunkLZ32IIH2_cjs.queryVectorsResponseSchema,
...
var LIST_INDEXES_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/vector/:vectorName/indexes",
  responseType: "json",
  pathParamSchema: chunkLZ32IIH2_cjs.vectorNamePathParams,
  responseSchema: chunkLZ32IIH2_cjs.listIndexesResponseSchema,
...
var DESCRIBE_INDEX_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/vector/:vectorName/indexes/:indexName",
  responseType: "json",
  pathParamSchema: chunkLZ32IIH2_cjs.vectorIndexPathParams,
  responseSchema: chunkLZ32IIH2_cjs.describeIndexResponseSchema,
...
var DELETE_INDEX_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "DELETE",
  path: "/vector/:vectorName/indexes/:indexName",
  responseType: "json",
  pathParamSchema: chunkLZ32IIH2_cjs.vectorIndexPathParams,
  responseSchema: chunkLZ32IIH2_cjs.deleteIndexResponseSchema,
...
var LIST_VECTORS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/vectors",
  responseType: "json",
  responseSchema: chunkLZ32IIH2_cjs.listVectorsResponseSchema,
...
var LIST_EMBEDDERS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/embedders",
  responseType: "json",
  responseSchema: chunkLZ32IIH2_cjs.listEmbeddersResponseSchema,
  ...
  handler: async () => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing embedders");
    }
  }
});
...
//# sourceMappingURL=chunk-QPICFOIK.cjs.map
//# sourceMappingURL=chunk-QPICFOIK.cjs.map