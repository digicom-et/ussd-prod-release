...
function detectProcessorPhases(processor) {
  if (processors.isProcessorWorkflow(processor)) {
...
var LIST_PROCESSORS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/processors",
  responseType: "json",
  responseSchema: chunkTMGV2NRM_cjs.listProcessorsResponseSchema,
  ...
  handler: async ({ mastra }) => {
    try {
      const processors$1 = mastra.listProcessors() || {};
      const processorConfigurations = mastra.listProcessorConfigurations();
      const result = {};
      for (const [processorKey, processorEntry] of Object.entries(processors$1)) {
        const processor = processorEntry;
        const processorId = processor.id || processorKey;
        const isWorkflow = processors.isProcessorWorkflow(processor);
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting processors");
    }
  }
});
var GET_PROCESSOR_BY_ID_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/processors/:processorId",
  responseType: "json",
  pathParamSchema: chunkTMGV2NRM_cjs.processorIdPathParams,
  responseSchema: chunkTMGV2NRM_cjs.serializedProcessorDetailSchema,
  ...
  handler: async ({ mastra, processorId }) => {
    try {
      ...
      if (!processorEntry) {
        throw new chunk64ITUOXI_cjs.HTTPException(404, { message: "Processor not found" });
      }
      const isWorkflow = processors.isProcessorWorkflow(processorEntry);
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting processor");
    }
  }
});
var EXECUTE_PROCESSOR_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/processors/:processorId/execute",
  responseType: "json",
  pathParamSchema: chunkTMGV2NRM_cjs.processorIdPathParams,
  bodySchema: chunkTMGV2NRM_cjs.executeProcessorBodySchema,
  responseSchema: chunkTMGV2NRM_cjs.executeProcessorResponseSchema,
  ...
  handler: async ({ mastra, processorId, ...bodyParams }) => {
    try {
      ...
      if (!processorId) {
        throw new chunk64ITUOXI_cjs.HTTPException(400, { message: "Processor ID is required" });
      }
      if (!phase) {
        throw new chunk64ITUOXI_cjs.HTTPException(400, { message: "Phase is required" });
      }
      if (!messages || !Array.isArray(messages)) {
        throw new chunk64ITUOXI_cjs.HTTPException(400, { message: "Messages array is required" });
      }
      let processor;
      try {
      ...
      if (processors.isProcessorWorkflow(processor)) {
        try {
          ...
          if (output && typeof output === "object") {
            ...
            } else if ("messageList" in output && output.messageList instanceof agent.MessageList) {
        ...
        switch (phase) {
          case "input":
            if (!processor.processInput) {
              throw new chunk64ITUOXI_cjs.HTTPException(400, { message: "Processor does not support input phase" });
            }
          ...
          case "inputStep":
            if (!processor.processInputStep) {
              throw new chunk64ITUOXI_cjs.HTTPException(400, { message: "Processor does not support inputStep phase" });
            }
          ...
          case "outputResult":
            if (!processor.processOutputResult) {
              throw new chunk64ITUOXI_cjs.HTTPException(400, { message: "Processor does not support outputResult phase" });
            }
          ...
          case "outputStep":
            if (!processor.processOutputStep) {
              throw new chunk64ITUOXI_cjs.HTTPException(400, { message: "Processor does not support outputStep phase" });
            }
          ...
          default:
            throw new chunk64ITUOXI_cjs.HTTPException(400, { message: `Unknown phase: ${phase}` });
        }
        let outputMessages = messages;
        if (result) {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error executing processor");
    }
  }
});
...
//# sourceMappingURL=chunk-XPJZ72ZH.cjs.map
//# sourceMappingURL=chunk-XPJZ72ZH.cjs.map