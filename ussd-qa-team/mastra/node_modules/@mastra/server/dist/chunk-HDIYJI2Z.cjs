...
function getCallerAuthorId(requestContext) {
  const resourceId = requestContext.get(chunkSXKQ7CSX_cjs.MASTRA_RESOURCE_ID_KEY);
  if (typeof resourceId === "string" && resourceId.length > 0) {
    return resourceId;
  }
  const user = requestContext.get(chunkSXKQ7CSX_cjs.MASTRA_USER_KEY);
...
function getCallerPermissions(requestContext) {
  const raw = requestContext.get(chunkSXKQ7CSX_cjs.MASTRA_USER_PERMISSIONS_KEY);
...
//# sourceMappingURL=chunk-HDIYJI2Z.cjs.map
//# sourceMappingURL=chunk-HDIYJI2Z.cjs.map