...
var LIST_SCORER_VERSIONS_ROUTE = createRoute({
  method: "GET",
...
var CREATE_SCORER_VERSION_ROUTE = createRoute({
  method: "POST",
  path: "/stored/scorers/:scorerId/versions",
  requiresAuth: true,
  responseType: "json",
...
var GET_SCORER_VERSION_ROUTE = createRoute({
  method: "GET",
...
var ACTIVATE_SCORER_VERSION_ROUTE = createRoute({
  method: "POST",
...
var RESTORE_SCORER_VERSION_ROUTE = createRoute({
  method: "POST",
...
var DELETE_SCORER_VERSION_ROUTE = createRoute({
  method: "DELETE",
  path: "/stored/scorers/:scorerId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
...
var COMPARE_SCORER_VERSIONS_ROUTE = createRoute({
  method: "GET",
...
//# sourceMappingURL=chunk-JGHI6QE5.js.map
//# sourceMappingURL=chunk-JGHI6QE5.js.map