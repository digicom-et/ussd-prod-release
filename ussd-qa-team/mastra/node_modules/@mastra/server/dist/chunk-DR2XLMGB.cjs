...
chunkO7I5CWRX_cjs.__export(workspace_exports, {
...
function handleWorkspaceError(error, defaultMessage) {
  if (isFilesystemNotFoundError(error)) {
    ...
    throw new chunk64ITUOXI_cjs.HTTPException(404, { message });
  }
  if (isFilesystemPermissionError(error)) {
    const message = error instanceof Error ? error.message : "Permission denied";
    throw new chunk64ITUOXI_cjs.HTTPException(403, { message });
  }
  return chunkZ7LCIYK7_cjs.handleError(error, defaultMessage);
}
...
function buildSkillInstallPath(filesystem, safeSkillId, requestedMount) {
  if (isCompositeFilesystem(filesystem)) {
    if (requestedMount) {
      ...
      if (mountFs.readOnly) {
        throw new chunk64ITUOXI_cjs.HTTPException(403, { message: `Mount "${requestedMount}" is read-only` });
      }
    ...
    throw new chunk64ITUOXI_cjs.HTTPException(403, { message: "No writable mount available for skill installation" });
  }
  return `${SKILLS_SH_DIR}/${safeSkillId}`;
}
var LIST_WORKSPACES_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces",
  responseType: "json",
  responseSchema: chunkHXICAUTW_cjs.listWorkspacesResponseSchema,
...
var GET_WORKSPACE_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces/:workspaceId",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  responseSchema: chunkHXICAUTW_cjs.workspaceInfoResponseSchema,
...
var WORKSPACE_FS_READ_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces/:workspaceId/fs/read",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  queryParamSchema: chunkHXICAUTW_cjs.fsReadQuerySchema,
  responseSchema: chunkHXICAUTW_cjs.fsReadResponseSchema,
...
var WORKSPACE_FS_WRITE_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/workspaces/:workspaceId/fs/write",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  bodySchema: chunkHXICAUTW_cjs.fsWriteBodySchema,
  responseSchema: chunkHXICAUTW_cjs.fsWriteResponseSchema,
...
var WORKSPACE_FS_LIST_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces/:workspaceId/fs/list",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  queryParamSchema: chunkHXICAUTW_cjs.fsListQuerySchema,
  responseSchema: chunkHXICAUTW_cjs.fsListResponseSchema,
...
var WORKSPACE_FS_DELETE_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "DELETE",
  path: "/workspaces/:workspaceId/fs/delete",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  queryParamSchema: chunkHXICAUTW_cjs.fsDeleteQuerySchema,
  responseSchema: chunkHXICAUTW_cjs.fsDeleteResponseSchema,
...
var WORKSPACE_FS_MKDIR_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/workspaces/:workspaceId/fs/mkdir",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  bodySchema: chunkHXICAUTW_cjs.fsMkdirBodySchema,
  responseSchema: chunkHXICAUTW_cjs.fsMkdirResponseSchema,
...
var WORKSPACE_FS_STAT_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces/:workspaceId/fs/stat",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  queryParamSchema: chunkHXICAUTW_cjs.fsStatQuerySchema,
  responseSchema: chunkHXICAUTW_cjs.fsStatResponseSchema,
...
var WORKSPACE_SEARCH_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces/:workspaceId/search",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  queryParamSchema: chunkHXICAUTW_cjs.searchQuerySchema,
  responseSchema: chunkHXICAUTW_cjs.searchResponseSchema,
...
var WORKSPACE_INDEX_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/workspaces/:workspaceId/index",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  bodySchema: chunkHXICAUTW_cjs.indexBodySchema,
  responseSchema: chunkHXICAUTW_cjs.indexResponseSchema,
...
var WORKSPACE_LIST_SKILLS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces/:workspaceId/skills",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  responseSchema: chunkHXICAUTW_cjs.listSkillsResponseSchema,
...
var WORKSPACE_GET_SKILL_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces/:workspaceId/skills/:skillName",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.skillNamePathParams,
  queryParamSchema: chunkHXICAUTW_cjs.skillDisambiguationQuerySchema,
  responseSchema: chunkHXICAUTW_cjs.getSkillResponseSchema,
...
var WORKSPACE_LIST_SKILL_REFERENCES_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces/:workspaceId/skills/:skillName/references",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.skillNamePathParams,
  queryParamSchema: chunkHXICAUTW_cjs.skillDisambiguationQuerySchema,
  responseSchema: chunkHXICAUTW_cjs.listReferencesResponseSchema,
...
var WORKSPACE_GET_SKILL_REFERENCE_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces/:workspaceId/skills/:skillName/references/:referencePath",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.skillReferencePathParams,
  queryParamSchema: chunkHXICAUTW_cjs.skillDisambiguationQuerySchema,
  responseSchema: chunkHXICAUTW_cjs.skillReferenceResponseSchema,
  ...
  handler: async ({ mastra, skillName, path: skillPath, referencePath, workspaceId, requestContext }) => {
    try {
      ...
      try {
        ...
        throw new chunk64ITUOXI_cjs.HTTPException(400, { message: "Malformed referencePath" });
      }
...
var WORKSPACE_SEARCH_SKILLS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces/:workspaceId/skills/search",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  queryParamSchema: chunkHXICAUTW_cjs.searchSkillsQuerySchema,
  responseSchema: chunkHXICAUTW_cjs.searchSkillsResponseSchema,
...
var WORKSPACE_SKILLS_SH_SEARCH_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces/:workspaceId/skills-sh/search",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  queryParamSchema: chunkHXICAUTW_cjs.skillsShSearchQuerySchema,
  responseSchema: chunkHXICAUTW_cjs.skillsShSearchResponseSchema,
  ...
  handler: async ({ q, limit }) => {
    try {
      ...
      if (error instanceof chunk64ITUOXI_cjs.HTTPException) {
        throw error;
      }
      return chunkZ7LCIYK7_cjs.handleError(error, "Error searching skills");
    }
  }
});
var WORKSPACE_SKILLS_SH_POPULAR_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces/:workspaceId/skills-sh/popular",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  queryParamSchema: chunkHXICAUTW_cjs.skillsShPopularQuerySchema,
  responseSchema: chunkHXICAUTW_cjs.skillsShListResponseSchema,
...
var WORKSPACE_SKILLS_SH_PREVIEW_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/workspaces/:workspaceId/skills-sh/preview",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  queryParamSchema: chunkHXICAUTW_cjs.skillsShPreviewQuerySchema,
  responseSchema: chunkHXICAUTW_cjs.skillsShPreviewResponseSchema,
...
var WORKSPACE_SKILLS_SH_INSTALL_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/workspaces/:workspaceId/skills-sh/install",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  bodySchema: chunkHXICAUTW_cjs.skillsShInstallBodySchema,
  responseSchema: chunkHXICAUTW_cjs.skillsShInstallResponseSchema,
  ...
  handler: async ({ mastra, workspaceId, owner, repo, skillName, mount }) => {
    try {
      ...
      const workspace = await getWorkspaceById(mastra, workspaceId);
      if (!workspace) {
        throw new chunk64ITUOXI_cjs.HTTPException(404, { message: "Workspace not found" });
      }
      if (!workspace.filesystem) {
        throw new chunk64ITUOXI_cjs.HTTPException(400, { message: "Workspace filesystem not available" });
      }
      if (workspace.filesystem.readOnly) {
        throw new chunk64ITUOXI_cjs.HTTPException(403, { message: "Workspace is read-only" });
      }
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error installing skill");
    }
  }
});
var WORKSPACE_SKILLS_SH_REMOVE_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/workspaces/:workspaceId/skills-sh/remove",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  bodySchema: chunkHXICAUTW_cjs.skillsShRemoveBodySchema,
  responseSchema: chunkHXICAUTW_cjs.skillsShRemoveResponseSchema,
  ...
  handler: async ({ mastra, workspaceId, skillName }) => {
    try {
      ...
      try {
        ...
        throw new chunk64ITUOXI_cjs.HTTPException(404, { message: `Skill "${skillName}" not found at ${skillPath}` });
      }
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error removing skill");
    }
  }
});
var WORKSPACE_SKILLS_SH_UPDATE_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/workspaces/:workspaceId/skills-sh/update",
  responseType: "json",
  pathParamSchema: chunkHXICAUTW_cjs.workspaceIdPathParams,
  bodySchema: chunkHXICAUTW_cjs.skillsShUpdateBodySchema,
  responseSchema: chunkHXICAUTW_cjs.skillsShUpdateResponseSchema,
  ...
  handler: async ({ mastra, workspaceId, skillName }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error updating skills");
    }
  }
});
...
exports.WORKSPACE_SKILLS_SH_INSTALL_ROUTE = WORKSPACE_SKILLS_SH_INSTALL_ROUTE;
exports.WORKSPACE_SKILLS_SH_POPULAR_ROUTE = WORKSPACE_SKILLS_SH_POPULAR_ROUTE;
exports.WORKSPACE_SKILLS_SH_PREVIEW_ROUTE = WORKSPACE_SKILLS_SH_PREVIEW_ROUTE;
exports.WORKSPACE_SKILLS_SH_REMOVE_ROUTE = WORKSPACE_SKILLS_SH_REMOVE_ROUTE;
exports.WORKSPACE_SKILLS_SH_ROUTES = WORKSPACE_SKILLS_SH_ROUTES;
...
//# sourceMappingURL=chunk-DR2XLMGB.cjs.map
//# sourceMappingURL=chunk-DR2XLMGB.cjs.map