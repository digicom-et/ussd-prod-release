import { resolveAuthorFilter, matchesAuthorFilter, assertReadAccess, getCallerAuthorId, assertWriteAccess } from './chunk-SXZS6VZ3.js';
...
var LIST_STORED_WORKSPACES_ROUTE = createRoute({
  method: "GET",
...
var GET_STORED_WORKSPACE_ROUTE = createRoute({
  method: "GET",
...
var CREATE_STORED_WORKSPACE_ROUTE = createRoute({
  method: "POST",
  path: "/stored/workspaces",
  responseType: "json",
...
var UPDATE_STORED_WORKSPACE_ROUTE = createRoute({
  method: "PATCH",
  path: "/stored/workspaces/:storedWorkspaceId",
  responseType: "json",
  pathParamSchema: storedWorkspaceIdPathParams,
...
var DELETE_STORED_WORKSPACE_ROUTE = createRoute({
  method: "DELETE",
  path: "/stored/workspaces/:storedWorkspaceId",
  responseType: "json",
  pathParamSchema: storedWorkspaceIdPathParams,
...
//# sourceMappingURL=chunk-ICWJHWEM.js.map
//# sourceMappingURL=chunk-ICWJHWEM.js.map