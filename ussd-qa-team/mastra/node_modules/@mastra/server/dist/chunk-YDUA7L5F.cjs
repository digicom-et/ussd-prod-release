...
function resolveOwnerId(requestContext$1, logger) {
  ...
  const user = requestContext$1?.get(chunkSXKQ7CSX_cjs.MASTRA_USER_KEY);
...
var LIST_TOOL_PROVIDERS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/tool-providers",
  responseType: "json",
  responseSchema: chunkPXLC5SNM_cjs.listToolProvidersResponseSchema,
  ...
  handler: async ({ mastra }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing tool providers");
    }
  }
});
var LIST_TOOL_PROVIDER_TOOLKITS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/tool-providers/:providerId/toolkits",
  responseType: "json",
  pathParamSchema: chunkPXLC5SNM_cjs.toolProviderIdPathParams,
  responseSchema: chunkPXLC5SNM_cjs.listToolProviderToolkitsResponseSchema,
  ...
  handler: async ({ mastra, providerId }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing tool provider toolkits");
    }
  }
});
var LIST_TOOL_PROVIDER_TOOLS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/tool-providers/:providerId/tools",
  responseType: "json",
  pathParamSchema: chunkPXLC5SNM_cjs.toolProviderIdPathParams,
  queryParamSchema: chunkPXLC5SNM_cjs.listToolProviderToolsQuerySchema,
  responseSchema: chunkPXLC5SNM_cjs.listToolProviderToolsResponseSchema,
  ...
  handler: async ({ mastra, providerId, toolkit, search, page, perPage }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing tool provider tools");
    }
  }
});
var GET_TOOL_PROVIDER_TOOL_SCHEMA_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/tool-providers/:providerId/tools/:toolSlug/schema",
  responseType: "json",
  pathParamSchema: chunkPXLC5SNM_cjs.toolSlugPathParams,
  responseSchema: chunkPXLC5SNM_cjs.getToolProviderToolSchemaResponseSchema,
  ...
  handler: async ({ mastra, providerId, toolSlug }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting tool provider tool schema");
    }
  }
});
var AUTHORIZE_TOOL_PROVIDER_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/tool-providers/:providerId/authorize",
  responseType: "json",
  pathParamSchema: chunkPXLC5SNM_cjs.toolProviderIdPathParams,
  bodySchema: chunkPXLC5SNM_cjs.authorizeToolProviderBodySchema,
  responseSchema: chunkPXLC5SNM_cjs.authorizeToolProviderResponseSchema,
  ...
  handler: async ({ mastra, providerId, toolkit, connectionId, toolName, config, label, scope, requestContext: requestContext$1 }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error authorizing tool provider");
    }
  }
});
var GET_TOOL_PROVIDER_AUTH_STATUS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/tool-providers/:providerId/auth-status/:authId",
  responseType: "json",
  pathParamSchema: chunkPXLC5SNM_cjs.toolProviderAuthStatusPathParams,
  responseSchema: chunkPXLC5SNM_cjs.authStatusToolProviderResponseSchema,
  ...
  handler: async ({ mastra, providerId, authId }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting tool provider auth status");
    }
  }
});
var TOOL_PROVIDER_CONNECTION_STATUS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/tool-providers/:providerId/connection-status",
  responseType: "json",
  pathParamSchema: chunkPXLC5SNM_cjs.toolProviderIdPathParams,
  bodySchema: chunkPXLC5SNM_cjs.connectionStatusToolProviderBodySchema,
  responseSchema: chunkPXLC5SNM_cjs.connectionStatusToolProviderResponseSchema,
  ...
  handler: async ({ mastra, providerId, items }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting connection status");
    }
  }
});
var LIST_TOOL_PROVIDER_CONNECTIONS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/tool-providers/:providerId/connections",
  responseType: "json",
  pathParamSchema: chunkPXLC5SNM_cjs.toolProviderIdPathParams,
  queryParamSchema: chunkPXLC5SNM_cjs.listConnectionsQuerySchema,
  responseSchema: chunkPXLC5SNM_cjs.listConnectionsResponseSchema,
  ...
  handler: async ({
    ...
    try {
      ...
      const isAdmin = requestContext ? chunkHDIYJI2Z_cjs.hasAdminBypass(requestContext, TOOL_PROVIDERS_RESOURCE) : false;
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing tool provider connections");
    }
  }
});
var LIST_TOOL_PROVIDER_CONNECTION_FIELDS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/tool-providers/:providerId/connection-fields",
  responseType: "json",
  pathParamSchema: chunkPXLC5SNM_cjs.toolProviderIdPathParams,
  queryParamSchema: chunkPXLC5SNM_cjs.listConnectionFieldsQuerySchema,
  responseSchema: chunkPXLC5SNM_cjs.listConnectionFieldsResponseSchema,
  ...
  handler: async ({ mastra, providerId, toolkit }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing tool provider connection fields");
    }
  }
});
var DISCONNECT_TOOL_PROVIDER_CONNECTION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "DELETE",
  path: "/tool-providers/:providerId/connections/:connectionId",
  responseType: "json",
  pathParamSchema: chunkPXLC5SNM_cjs.toolProviderConnectionPathParams,
  queryParamSchema: chunkPXLC5SNM_cjs.disconnectConnectionQuerySchema,
  responseSchema: chunkPXLC5SNM_cjs.disconnectConnectionResponseSchema,
  ...
  handler: async ({ mastra, providerId, connectionId, force, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error disconnecting tool provider connection");
    }
  }
});
var UPDATE_TOOL_PROVIDER_CONNECTION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "PATCH",
  path: "/tool-providers/:providerId/connections/:connectionId",
  responseType: "json",
  pathParamSchema: chunkPXLC5SNM_cjs.toolProviderConnectionPathParams,
  bodySchema: chunkPXLC5SNM_cjs.updateConnectionBodySchema,
  responseSchema: chunkPXLC5SNM_cjs.updateConnectionResponseSchema,
  ...
  handler: async ({ mastra, providerId, connectionId, label, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error updating tool provider connection");
    }
  }
});
var GET_TOOL_PROVIDER_CONNECTION_USAGE_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/tool-providers/:providerId/connections/:connectionId/usage",
  responseType: "json",
  pathParamSchema: chunkPXLC5SNM_cjs.toolProviderConnectionPathParams,
  queryParamSchema: chunkPXLC5SNM_cjs.connectionUsageQuerySchema,
  responseSchema: chunkPXLC5SNM_cjs.connectionUsageResponseSchema,
  ...
  handler: async ({ mastra, providerId, connectionId, toolkit, requestContext }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing tool provider connection usage");
    }
  }
});
var GET_TOOL_PROVIDER_HEALTH_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/tool-providers/:providerId/health",
  responseType: "json",
  pathParamSchema: chunkPXLC5SNM_cjs.toolProviderIdPathParams,
  responseSchema: chunkPXLC5SNM_cjs.toolProviderHealthResponseSchema,
  ...
  handler: async ({ mastra, providerId }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting tool provider health");
    }
  }
});
...
//# sourceMappingURL=chunk-YDUA7L5F.cjs.map
//# sourceMappingURL=chunk-YDUA7L5F.cjs.map