import { listPromptBlockVersionsResponseSchema, listPromptBlockVersionsQuerySchema, promptBlockVersionPathParams, createPromptBlockVersionResponseSchema, createPromptBlockVersionBodySchema, getPromptBlockVersionResponseSchema, promptBlockVersionIdPathParams, activatePromptBlockVersionResponseSchema, restorePromptBlockVersionResponseSchema, deletePromptBlockVersionResponseSchema, comparePromptBlockVersionsResponseSchema, comparePromptBlockVersionsQuerySchema } from './chunk-3BLT6ISZ.js';
...
var LIST_PROMPT_BLOCK_VERSIONS_ROUTE = createRoute({
  method: "GET",
...
var CREATE_PROMPT_BLOCK_VERSION_ROUTE = createRoute({
  method: "POST",
  path: "/stored/prompt-blocks/:promptBlockId/versions",
  requiresAuth: true,
  responseType: "json",
...
var GET_PROMPT_BLOCK_VERSION_ROUTE = createRoute({
  method: "GET",
...
var ACTIVATE_PROMPT_BLOCK_VERSION_ROUTE = createRoute({
  method: "POST",
...
var RESTORE_PROMPT_BLOCK_VERSION_ROUTE = createRoute({
  method: "POST",
...
var DELETE_PROMPT_BLOCK_VERSION_ROUTE = createRoute({
  method: "DELETE",
  path: "/stored/prompt-blocks/:promptBlockId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
...
var COMPARE_PROMPT_BLOCK_VERSIONS_ROUTE = createRoute({
  method: "GET",
...
//# sourceMappingURL=chunk-OJLVR6RK.js.map
//# sourceMappingURL=chunk-OJLVR6RK.js.map