...
var LIST_DATASETS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/datasets",
  responseType: "json",
  queryParamSchema: chunkL5D33443_cjs.paginationQuerySchema,
  responseSchema: chunkL5D33443_cjs.listDatasetsResponseSchema,
  ...
  handler: async ({ mastra, ...params }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error listing datasets");
    }
  }
});
var CREATE_DATASET_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/datasets",
  responseType: "json",
  bodySchema: chunkL5D33443_cjs.createDatasetBodySchema,
  responseSchema: chunkL5D33443_cjs.datasetResponseSchema,
  ...
  handler: async ({ mastra, ...params }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error creating dataset");
    }
  }
});
var GET_DATASET_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetIdPathParams,
  responseSchema: chunkL5D33443_cjs.datasetResponseSchema.nullable(),
  ...
  handler: async ({ mastra, datasetId }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error getting dataset");
    }
  }
});
var UPDATE_DATASET_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "PATCH",
  path: "/datasets/:datasetId",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetIdPathParams,
  bodySchema: chunkL5D33443_cjs.updateDatasetBodySchema,
  responseSchema: chunkL5D33443_cjs.datasetResponseSchema,
  ...
  handler: async ({ mastra, datasetId, ...params }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error updating dataset");
    }
  }
});
var DELETE_DATASET_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "DELETE",
  path: "/datasets/:datasetId",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetIdPathParams,
  responseSchema: chunkDIG2K5CV_cjs.successResponseSchema,
  ...
  handler: async ({ mastra, datasetId }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error deleting dataset");
    }
  }
});
var LIST_ITEMS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/items",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetIdPathParams,
  queryParamSchema: chunkL5D33443_cjs.listItemsQuerySchema,
  responseSchema: chunkL5D33443_cjs.listItemsResponseSchema,
  ...
  handler: async ({ mastra, datasetId, ...params }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error listing dataset items");
    }
  }
});
var ADD_ITEM_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/items",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetIdPathParams,
  bodySchema: chunkL5D33443_cjs.addItemBodySchema,
  responseSchema: chunkL5D33443_cjs.datasetItemResponseSchema,
  ...
  handler: async ({ mastra, datasetId, ...params }) => {
    assertDatasetsAvailable();
    try {
      const { input, groundTruth, requestContext, metadata, source, expectedTrajectory, toolMocks } = params;
      const ds = await mastra.datasets.get({ id: datasetId });
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error adding item to dataset");
    }
  }
});
var GET_ITEM_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/items/:itemId",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetAndItemIdPathParams,
  responseSchema: chunkL5D33443_cjs.datasetItemResponseSchema.nullable(),
  ...
  handler: async ({ mastra, datasetId, itemId }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error getting dataset item");
    }
  }
});
var UPDATE_ITEM_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "PATCH",
  path: "/datasets/:datasetId/items/:itemId",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetAndItemIdPathParams,
  bodySchema: chunkL5D33443_cjs.updateItemBodySchema,
  responseSchema: chunkL5D33443_cjs.datasetItemResponseSchema,
  ...
  handler: async ({ mastra, datasetId, itemId, ...params }) => {
    assertDatasetsAvailable();
    try {
      const { input, groundTruth, requestContext, metadata, expectedTrajectory, toolMocks } = params;
      const ds = await mastra.datasets.get({ id: datasetId });
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error updating dataset item");
    }
  }
});
var DELETE_ITEM_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "DELETE",
  path: "/datasets/:datasetId/items/:itemId",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetAndItemIdPathParams,
  ...
  handler: async ({ mastra, datasetId, itemId }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error deleting dataset item");
    }
  }
});
var LIST_ALL_EXPERIMENTS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/experiments",
  responseType: "json",
  queryParamSchema: chunkL5D33443_cjs.paginationQuerySchema,
  responseSchema: chunkL5D33443_cjs.listExperimentsResponseSchema,
  ...
  handler: async ({ mastra, ...params }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error listing experiments");
    }
  }
});
var EXPERIMENT_REVIEW_SUMMARY_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/experiments/review-summary",
  responseType: "json",
  responseSchema: chunkL5D33443_cjs.reviewSummaryResponseSchema,
  ...
  handler: async ({ mastra }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error getting review summary");
    }
  }
});
var LIST_EXPERIMENTS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
...
var TRIGGER_EXPERIMENT_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/experiments",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetIdPathParams,
  bodySchema: chunkL5D33443_cjs.triggerExperimentBodySchema,
  responseSchema: chunkL5D33443_cjs.experimentSummaryResponseSchema,
  ...
  handler: async ({ mastra, datasetId, ...params }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error triggering experiment");
    }
  }
});
var GET_EXPERIMENT_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/experiments/:experimentId",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetAndExperimentIdPathParams,
  responseSchema: chunkL5D33443_cjs.experimentResponseSchema.nullable(),
  ...
  handler: async ({ mastra, datasetId, experimentId }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error getting experiment");
    }
  }
});
var LIST_EXPERIMENT_RESULTS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/experiments/:experimentId/results",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetAndExperimentIdPathParams,
  queryParamSchema: chunkL5D33443_cjs.paginationQuerySchema,
  responseSchema: chunkL5D33443_cjs.listExperimentResultsResponseSchema,
  ...
  handler: async ({ mastra, datasetId, experimentId, ...params }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error listing experiment results");
    }
  }
});
var UPDATE_EXPERIMENT_RESULT_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "PATCH",
  path: "/datasets/:datasetId/experiments/:experimentId/results/:resultId",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.experimentResultIdPathParams,
  bodySchema: chunkL5D33443_cjs.updateExperimentResultBodySchema,
  responseSchema: chunkL5D33443_cjs.experimentResultResponseSchema,
  ...
  handler: async ({ mastra, resultId, experimentId, ...params }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error updating experiment result");
    }
  }
});
var COMPARE_EXPERIMENTS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/compare",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetIdPathParams,
  bodySchema: chunkL5D33443_cjs.compareExperimentsBodySchema,
  responseSchema: chunkL5D33443_cjs.comparisonResponseSchema,
  ...
  handler: async ({ mastra, datasetId, ...params }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error comparing experiments");
    }
  }
});
var LIST_DATASET_VERSIONS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/versions",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetIdPathParams,
  queryParamSchema: chunkL5D33443_cjs.paginationQuerySchema,
  responseSchema: chunkL5D33443_cjs.listDatasetVersionsResponseSchema,
  ...
  handler: async ({ mastra, datasetId, ...params }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error listing dataset versions");
    }
  }
});
var LIST_ITEM_VERSIONS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/items/:itemId/history",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetAndItemIdPathParams,
  responseSchema: chunkL5D33443_cjs.listItemVersionsResponseSchema,
  ...
  handler: async ({ mastra, datasetId, itemId }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error listing item history");
    }
  }
});
var GET_ITEM_VERSION_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/items/:itemId/versions/:datasetVersion",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetItemVersionPathParams,
  responseSchema: chunkL5D33443_cjs.datasetItemResponseSchema.nullable(),
  ...
  handler: async ({ mastra, datasetId, itemId, datasetVersion }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error getting item version");
    }
  }
});
var BATCH_INSERT_ITEMS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/items/batch",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetIdPathParams,
  bodySchema: chunkL5D33443_cjs.batchInsertItemsBodySchema,
  responseSchema: chunkL5D33443_cjs.batchInsertItemsResponseSchema,
  ...
  handler: async ({ mastra, datasetId, ...params }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error batch inserting items");
    }
  }
});
var BATCH_DELETE_ITEMS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "DELETE",
  path: "/datasets/:datasetId/items/batch",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetIdPathParams,
  bodySchema: chunkL5D33443_cjs.batchDeleteItemsBodySchema,
  responseSchema: chunkL5D33443_cjs.batchDeleteItemsResponseSchema,
  ...
  handler: async ({ mastra, datasetId, ...params }) => {
    ...
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error bulk deleting items");
    }
  }
});
...
var GENERATE_ITEMS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/generate-items",
  responseType: "json",
  pathParamSchema: chunkL5D33443_cjs.datasetIdPathParams,
  bodySchema: chunkL5D33443_cjs.generateItemsBodySchema,
  responseSchema: chunkL5D33443_cjs.generateItemsResponseSchema,
...
${agentContextSection}` : null,
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error generating dataset items");
    }
  }
});
...
var CLUSTER_FAILURES_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/datasets/cluster-failures",
  responseType: "json",
  bodySchema: chunkL5D33443_cjs.clusterFailuresBodySchema,
  responseSchema: chunkL5D33443_cjs.clusterFailuresResponseSchema,
...
Return both "clusters" (grouping items by pattern) and "proposedTags" (a list mapping each item ID to the tag labels you recommend, with a "reason" explaining why). For proposedTags, only include NEW tags to add \u2014 do not repeat tags the item already has.`;
      ...
      return chunkZ7LCIYK7_cjs.handleError(error$1, "Error clustering failures");
    }
  }
});
...
//# sourceMappingURL=chunk-MTWCBGFH.cjs.map
//# sourceMappingURL=chunk-MTWCBGFH.cjs.map