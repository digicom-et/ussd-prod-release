...
var LIST_STORED_MCP_CLIENTS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/mcp-clients",
  responseType: "json",
  queryParamSchema: chunkWIOYCLJC_cjs.listStoredMCPClientsQuerySchema,
  responseSchema: chunkWIOYCLJC_cjs.listStoredMCPClientsResponseSchema,
...
var GET_STORED_MCP_CLIENT_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/stored/mcp-clients/:storedMCPClientId",
  responseType: "json",
  pathParamSchema: chunkWIOYCLJC_cjs.storedMCPClientIdPathParams,
  queryParamSchema: chunkDIG2K5CV_cjs.statusQuerySchema,
  responseSchema: chunkWIOYCLJC_cjs.getStoredMCPClientResponseSchema,
...
var CREATE_STORED_MCP_CLIENT_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "POST",
  path: "/stored/mcp-clients",
  responseType: "json",
  bodySchema: chunkWIOYCLJC_cjs.createStoredMCPClientBodySchema,
  responseSchema: chunkWIOYCLJC_cjs.createStoredMCPClientResponseSchema,
...
var UPDATE_STORED_MCP_CLIENT_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "PATCH",
  path: "/stored/mcp-clients/:storedMCPClientId",
  responseType: "json",
  pathParamSchema: chunkWIOYCLJC_cjs.storedMCPClientIdPathParams,
  bodySchema: chunkWIOYCLJC_cjs.updateStoredMCPClientBodySchema,
  responseSchema: chunkWIOYCLJC_cjs.updateStoredMCPClientResponseSchema,
...
var DELETE_STORED_MCP_CLIENT_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "DELETE",
  path: "/stored/mcp-clients/:storedMCPClientId",
  responseType: "json",
  pathParamSchema: chunkWIOYCLJC_cjs.storedMCPClientIdPathParams,
  responseSchema: chunkWIOYCLJC_cjs.deleteStoredMCPClientResponseSchema,
...
//# sourceMappingURL=chunk-IQZE4X6U.cjs.map
//# sourceMappingURL=chunk-IQZE4X6U.cjs.map