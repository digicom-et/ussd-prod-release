...
var LIST_PROCESSOR_PROVIDERS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/processor-providers",
  responseType: "json",
  responseSchema: chunk67F5GKI5_cjs.getProcessorProvidersResponseSchema,
  ...
  handler: async ({ mastra }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error listing processor providers");
    }
  }
});
var GET_PROCESSOR_PROVIDER_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/processor-providers/:providerId",
  responseType: "json",
  pathParamSchema: chunk67F5GKI5_cjs.processorProviderIdPathParams,
  responseSchema: chunk67F5GKI5_cjs.getProcessorProviderResponseSchema,
  ...
  handler: async ({ mastra, providerId }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting processor provider");
    }
  }
});
...
//# sourceMappingURL=chunk-JYWPYMQS.cjs.map
//# sourceMappingURL=chunk-JYWPYMQS.cjs.map