...
var LIST_LOG_TRANSPORTS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/logs/transports",
  responseType: "json",
  responseSchema: chunkC6CCPCEC_cjs.listLogTransportsResponseSchema,
  ...
  handler: async ({ mastra }) => {
    try {
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting log Transports");
    }
  }
});
var LIST_LOGS_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/logs",
  responseType: "json",
  queryParamSchema: chunkC6CCPCEC_cjs.listLogsQuerySchema,
  responseSchema: chunkC6CCPCEC_cjs.listLogsResponseSchema,
  summary: "List logs",
  ...
  handler: async ({ mastra, ...params }) => {
    try {
      ...
      chunk42M6Y2OD_cjs.validateBody({ transportId });
      const filters = chunk42M6Y2OD_cjs.parseFilters(_filters);
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting logs");
    }
  }
});
var LIST_LOGS_BY_RUN_ID_ROUTE = chunkDN2NUSL2_cjs.createRoute({
  method: "GET",
  path: "/logs/:runId",
  responseType: "json",
  ...
  handler: async ({ mastra, runId, ...params }) => {
    try {
      const { transportId, fromDate, toDate, logLevel, filters: _filters, page, perPage } = params;
      chunk42M6Y2OD_cjs.validateBody({ runId, transportId });
      const filters = chunk42M6Y2OD_cjs.parseFilters(_filters);
      ...
      return chunkZ7LCIYK7_cjs.handleError(error, "Error getting logs by run ID");
    }
  }
});
...
//# sourceMappingURL=chunk-5O3XY7Z3.cjs.map
//# sourceMappingURL=chunk-5O3XY7Z3.cjs.map